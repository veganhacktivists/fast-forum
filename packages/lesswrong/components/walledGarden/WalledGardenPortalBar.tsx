...
export const WalledGardenPortalBar = ({
  iframeRef,
  classes,
}: {
  ...
  return (
    <ContentStyles contentType="commentExceptPointerEvents" className={classes.root}>
        ...
        {currentUser?.walledGardenInvite && (
          <div className={classes.events}>
            ...
            <div className={classes.calendarLinks}>
              <div>
                <GardenCodeWidget type="friend" />
              </div>
              <div>
                <GardenCodeWidget type="event" />
              </div>
            </div>
          </div>
        )}
        ...
        {currentUser?.walledGardenInvite && (
          <div className={classes.calendars}>
            <div className={classes.textButton}>
              <a
                href={"https://www.facebook.com/groups/356586692361618/events"}
                target="_blank"
