...
export const makeLinkAbsolute = (link: string) => {
  return link.startsWith("http://") || link.startsWith("https://") ? link : `https://${link}`;
};

export const GardenCodesItem = ({ classes, gardenCode }: { classes: ClassesType; gardenCode: GardenCodeFragment }) => {
  ...
  return (
    <div className={classes.root}>
      <span className={classes.eventName}>
        {gardenCode.type === "private" && (
          <LWTooltip title="Your personal event" placement="right">
            <PersonIcon className={classes.personalIcon} />
          </LWTooltip>
        )}
        {gardenCode.contents?.htmlHighlight ? (
          <span>
            <LWTooltip
              title={
      ...
      <div className={classes.eventTime}>{eventFormat(gardenCode.startTime)}</div>
      <div className={classes.trailingIcons}>
        ...
        <div className={classes.fbIconContainer}>
          {" "}
          {/*container for fb icon to maintain spacing*/}
