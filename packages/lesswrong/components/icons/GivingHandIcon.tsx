...
// Copied from v5 of MUI: https://mui.com/material-ui/material-icons/?selected=VolunteerActivism
export const GivingHandIcon = (props: React.HTMLAttributes<SVGElement>) => {
  return (
    <svg width="16" height="16" viewBox="0 0 22 22" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
