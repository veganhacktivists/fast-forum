...
export const RibbonIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" id="Icons" viewBox="0 0 60 60" className={className}>
    <defs>
      <filter filterUnits="objectBoundingBox" id="pencilTexture5">
        <feTurbulence type="fractalNoise" baseFrequency="0.1" stitchTiles="stitch" result="t1"></feTurbulence>
        <feComposite operator="in" in2="t1" in="SourceGraphic" result="SourceTextured"></feComposite>
        <feTurbulence type="fractalNoise" baseFrequency="0.03" seed="1" result="f1"></feTurbulence>
        <feDisplacementMap
          xChannelSelector="R"
          yChannelSelector="G"
          scale="5"
