...
const RevisionSelect = ({
  ...
  return (
    <React.Fragment>
              ...
              <tr key={rev.version} className={classes.revisionRow}>
                <td>
                  <LWTooltip
                    title={
                      <div>
                        Select as the <em>first</em> revision to compare
                      </div>
                    }
                  >
                    <Radio
                      className={classNames(classes.radio, {
                        [classes.checked]: i === beforeRevisionIndex,
                        [classes.radioDisabled]: beforeDisabled,
                      })}
                ...
                <td>
                  <LWTooltip
                    title={
                      <div>
                        Select as the <em>second</em> revision to compare
                      </div>
                    }
                  >
                    <Radio
                      className={classNames(classes.radio, {
                        [classes.checked]: i === afterRevisionIndex,
                        [classes.radioDisabled]: afterDisabled,
                      })}
                ...
                <td>
                  <ChangeMetricsDisplay changeMetrics={rev.changeMetrics} /> {rev.commitMessage}
                </td>
              </tr>
            );
          })}
      ...
      <div>
        <LoadMore {...loadMoreProps} totalCount={totalCount} count={count} />
      </div>
      <Button className={classes.button} variant="outlined" onClick={compareRevs}>
...
const RevisionSelectComponent = registerComponent("RevisionSelect", RevisionSelect, { styles });
