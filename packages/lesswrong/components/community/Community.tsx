...
const Community = ({ classes }: { classes: ClassesType }) => {
   ...
   */
  const saveUserLocation = ({ lat, lng, gmaps }: { lat: number; lng: number; gmaps?: google.maps.GeocoderResult }) => {
  ...
  const saveReverseGeocodedLocation = async ({ lat, lng, known }: { lat: number; lng: number; known: boolean }) => {
    if (
  ...
  const { CommunityBanner, LocalGroups, OnlineGroups, CommunityMembers, GroupFormLink, DistanceUnitToggle, ForumIcon } =
    Components;
    ...
    <AnalyticsContext pageContext="Community">
      ...
      <div className={classes.section}>
        <Tabs
          ...
          scrollable
          aria-label="view local or online groups, or individual community members"
        >
          ...
          <div key="local">
            <div className={classes.filtersRow}>
              ...
              <div>
                ...
                {userLocation.known && (
                  <DistanceUnitToggle distanceUnit={distanceUnit} onChange={setDistanceUnit} skipDefaultEffect />
                )}
              </div>
            ...
            {includeInactive && (
              <div className={classes.filtersRow}>
                <Chip
                  ...
                  onDelete={handleToggleIncludeInactive}
            ...
            <div className={classes.localGroupsBtns}>
              <Button
                href="https://resources.eagroups.org/start-a-group"
                variant="outlined"
                color="primary"
                target="_blank"
                rel="noopener noreferrer"
                className={classes.localGroupsBtn}
              >
                Start your own group
                <OpenInNewIcon className={classes.localGroupsBtnIcon} />
              </Button>
              <Button
                href="https://docs.google.com/forms/d/e/1FAIpQLScMolewy1P1z9XNyFIN1mQFZQ1LE64QXJrIaX6enrfItWR9LQ/viewform"
                color="primary"
                target="_blank"
                rel="noopener noreferrer"
                className={classes.localGroupsBtn}
            ...
            <div className={classes.eventsPageLinkRow}>
              ...
              <Link to="/events" className={classes.eventsPageLink}>
          ...
          <div key="individuals">
            ...
            <div className={classes.localGroupsBtns}>
              <Button
                ...
                color="primary"
                className={classes.localGroupsBtn}
                onClick={openSetPersonalLocationForm}
              >
        ...
        {tab !== "individuals" && (
          <>
            {canCreateGroups && (
              <div className={classes.addGroup} title="Currently only visible to admins">
