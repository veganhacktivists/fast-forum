...
const CommunityMembersFullMap = ({ classes }: { classes: ClassesType }) => {
...
const CommunityMembersFullMapComponent = registerComponent("CommunityMembersFullMap", CommunityMembersFullMap, {
  styles,
});
