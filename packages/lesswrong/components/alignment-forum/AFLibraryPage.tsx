...
export const AFLibraryPage = ({ classes }: { classes: ClassesType }) => {
  const { SingleColumnSection, SectionTitle, Divider, SequencesNewButton, SequencesGridWrapper, Typography } =
    Components;
  ...
  return (
    <div className={classes.root}>
      <AnalyticsContext pageContext="sequencesHome">
        <SingleColumnSection>
          <Typography variant="display3" className={classes.pageTitle}>
            The Library
          </Typography>
        </SingleColumnSection>
        <SingleColumnSection>
