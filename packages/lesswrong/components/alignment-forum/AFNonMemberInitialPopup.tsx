...
// dialog.
const AFNonMemberInitialPopup = ({ onClose, classes }: { onClose?: () => void; classes: ClassesType }) => {
    ...
    >
      <Card className={classes.popupCard}>
        ...
        <div className={classes.buttonContainer}>
          <Button
            className={classes.understandConfirmationButton}
            color="primary"
            onClick={() => {
...
const AFNonMemberInitialPopupComponent = registerComponent("AFNonMemberInitialPopup", AFNonMemberInitialPopup, {
  styles,
});
