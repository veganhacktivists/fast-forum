...
const ShortformThreadList = ({ classes }: { classes: ClassesType }) => {
  ...
  const { LoadMore, CommentOnPostWithReplies, ShortformSubmitForm, QuickTakesEntry } = Components;
  return (
    <div>
      ...
      {results &&
        results.map((comment) => {
          ...
          return (
            <div key={comment._id} className={classes.shortformItem}>
