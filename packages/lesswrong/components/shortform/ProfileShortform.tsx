...
export const ProfileShortform = ({ classes, user }: { classes: ClassesType; user: UsersProfile }) => {
  ...
  return <div className={classes.root}>{document && <PostsItem post={document} hideAuthor forceSticky />}</div>;
};
