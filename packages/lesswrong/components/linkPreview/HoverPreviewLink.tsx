...
const HoverPreviewLink = ({
  ...
  if (href.startsWith("#")) {
    if (locationHashIsFootnote(href) && !isMobile()) {
      return (
        <Components.FootnotePreview href={href} id={id} rel={rel}>
          {children}
  ...
  try {
    ...
    if (!linkIsExcludedFromPreview(onsiteUrl) && (hostType === "onsite" || hostType === "mirrorOfUs" || isServer)) {
      ...
      if (parsedUrl.currentRoute) {
        const PreviewComponent: any = parsedUrl.currentRoute.previewComponentName
          ? Components[parsedUrl.currentRoute.previewComponentName]
          : null;
        ...
        if (PreviewComponent) {
          return (
            <AnalyticsContext
              ...
              href={destinationUrl}
              hoverPreviewType={parsedUrl.currentRoute.previewComponentName}
              onsite
            >
      ...
      if (linkTargetAbsolute.host === "hubs.mozilla.com") {
        return (
          <Components.MozillaHubPreview href={href} id={id}>
            {children}
      ...
      if (linkTargetAbsolute.host === "metaculus.com" || linkTargetAbsolute.host === "www.metaculus.com") {
        return (
          <Components.MetaculusPreview href={href} id={id}>
            {children}
      ...
      if (linkTargetAbsolute.host === "manifold.markets" || linkTargetAbsolute.host === "www.manifold.markets") {
        return (
          <Components.ManifoldPreview href={href} id={id}>
            {children}
      ...
      if (linkTargetAbsolute.host === "metaforecast.org" || linkTargetAbsolute.host === "www.metaforecast.org") {
        return (
          <Components.MetaforecastPreview href={href} id={id}>
            {children}
      ...
      if (linkTargetAbsolute.host === "ourworldindata.org") {
        return (
          <Components.OWIDPreview href={href} id={id}>
            {children}
      ...
      if (linkTargetAbsolute.host === "arbital.com" || linkTargetAbsolute.host === "www.arbital.com") {
        return (
          <Components.ArbitalPreview href={href} id={id}>
            {children}
      ...
      if (linkTargetAbsolute.host === "estimaker.app" || linkTargetAbsolute.host === "www.estimaker.app") {
        return (
          <Components.EstimakerPreview href={href} id={id}>
            {children}
      ...
      if (linkTargetAbsolute.host === "viewpoints.xyz" || linkTargetAbsolute.host === "www.viewpoints.xyz") {
        return (
          <Components.ViewpointsPreview href={href} id={id}>
            {children}
