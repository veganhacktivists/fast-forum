...
export const useDialogueMatchmaking = <T extends MatchmakingProps>(
  currentUser: UsersCurrent | null,
  props: T,
): UseDialogueMatchmakingResults<T> => {
  ...
  const matchedUsersQueryResult = useQuery(
    gql`
  ...
  const recommendedUsersQueryResult = useQuery(
    gql`
