      ...
      <div className={classes.root}>
        ...
        <div className={classes.section}>
          ...
          <Typography variant="body1" className={classes.sectionHelperText} gutterBottom>
            We encourage you to use your real name, as it will help other people in the community to identify you, but
            you can choose a pseudonym. If you do, try to choose{" "}
            <a
        ...
        {!currentUser?.email && (
          <div className={classes.section}>
            ...
            <Typography variant="body1" className={classes.sectionHelperText} gutterBottom>
              ...
              To get here without an email you must have logged in with Facebook and not given Facebook your email. We
              need your email to notify you of direct messages, and having a tiny percentage of users without an email
              makes the site harder to maintain.
            </Typography>
            <TextField label="Email" inputRef={emailInput} />
          </div>
        )}
        ...
        {isEAForum && (
          <div className={classes.section}>
            ...
            {/* FIXME: the mailchimp campaign doesn't exist yet */}
            {/* <Typography variant="body1" className={classes.sectionHelperText} gutterBottom> */}
            {/*   The FAST Forum Digest is curated by the Forum team, and features highlights from every week, */}
        ...
        <div className={classes.submitButtonSection}>
          {isEAForum && (
            <Typography variant="body1" className={classnames(classes.sectionHelperText, classes.tosText)} gutterBottom>
              I agree to the <TosLink />, including my content being available under a <LicenseLink /> license.
            </Typography>
          )}
...
const NewUserCompleteProfileComponent = registerComponent("NewUserCompleteProfile", NewUserCompleteProfile, { styles });
