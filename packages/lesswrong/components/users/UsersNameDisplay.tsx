...
export const DisableNoKibitzContext = createContext<DisableNoKibitzContextType>({
    ...
    <span className={className}>
      <span {...eventHandlers}>
        <AnalyticsContext pageElementContext="userNameDisplay" userIdDisplayed={user._id}>
          <UserTooltip user={user} placement={tooltipPlacement} inlineBlock={false}>
            <Link
              to={profileUrl}
...
const UsersNameDisplayComponent = registerComponent("UsersNameDisplay", UsersNameDisplay, { styles });
