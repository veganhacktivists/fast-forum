...
const LoginFormDefault = ({ startingState = "login", classes }: LoginFormProps) => {
  ...
  return (
    <Components.ContentStyles contentType="commentExceptPointerEvents">
        ...
        {hasOauthSection && (
          <>
            ...
            <div className={classes.oAuthBlock}>
              <a className={classes.oAuthLink} href={`/auth/facebook?returnTo=${pathname}`}>
                FACEBOOK
              </a>
              <a className={classes.oAuthLink} href={`/auth/google?returnTo=${pathname}`}>
                GOOGLE
              </a>
              <a className={classes.oAuthLink} href={`/auth/github?returnTo=${pathname}`}>
                GITHUB
              </a>
            </div>
          </>
  ...
  return (
    <Components.ContentStyles contentType="commentExceptPointerEvents">
      <div className={classnames(classes.oAuthBlock, "ea-forum")}>
        <a className={startingState === "login" ? classes.primaryBtn : classes.oAuthLink} href={urls.login}>
          Login
        </a>
        <a className={startingState === "signup" ? classes.primaryBtn : classes.oAuthLink} href={urls.signup}>
          Sign Up
        </a>
      </div>
    </Components.ContentStyles>
