...
const UsersEditForm = ({ terms, classes }: { terms: { slug?: string; documentId?: string }; classes: ClassesType }) => {
  ...
  const isCurrentUser =
    (terms.slug && terms.slug === currentUser?.slug) || (terms.documentId && terms.documentId === currentUser?._id);
  ...
  return (
    <div className={classes.root}>
      ...
      {isCurrentUser && !isEAForum && (
        <Button color="secondary" variant="outlined" className={classes.resetButton} onClick={requestPasswordReset}>
