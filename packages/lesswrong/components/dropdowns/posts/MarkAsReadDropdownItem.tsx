...
const MarkAsReadDropdownItem = ({ post }: { post: PostsBase }) => {
  ...
  return <DropdownItem title={preferredHeadingCase(title)} onClick={setRead.bind(null, !isRead)} />;
};

const MarkAsReadDropdownItemComponent = registerComponent("MarkAsReadDropdownItem", MarkAsReadDropdownItem);
