  ...
  const render = () => {
    ...
    return (
      <LWDialog open={true} onClose={onClose}>
        <DialogTitle>What is your reason for deleting this comment?</DialogTitle>
        <DialogContent>
          <p className={classes.subtitle}>
            <em>
              (If you delete without a trace, the reason will be sent to the author of the comment privately. Otherwise
              it will be publicly displayed below the comment.)
            </em>
          </p>
          <br />
          <TextField
...
const DeleteCommentDialogComponent = registerComponent("DeleteCommentDialog", DeleteCommentDialog, { styles });
