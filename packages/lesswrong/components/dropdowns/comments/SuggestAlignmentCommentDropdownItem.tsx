...
import {
  commentSuggestForAlignment,
  commentUnSuggestForAlignment,
} from "../../../lib/alignment-forum/comments/helpers";
...
const SuggestAlignmentCommentDropdownItem = ({
  comment,
  post,
  classes,
}: {
