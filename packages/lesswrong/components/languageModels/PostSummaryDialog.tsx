...
const PostSummaryDialog = ({ post, onClose }: { post: PostsList | SunshinePostsList; onClose?: () => void }) => {
...
const PostSummaryDialogComponent = registerComponent("PostSummaryDialog", PostSummaryDialog);
