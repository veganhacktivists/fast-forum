...
const Book2019Landing = ({ classes }: { classes: ClassesType }) => {
    ...
    <div>
      ...
      <div className={classNames(classes.textSettings, classes.wrapper)}>
        <div className={classes.title}>
          <div className={classes.bookTitle}>The Engines of Cognition</div>
        ...
        <div className={classes.bookCheckout}>
          <div className={classes.bookCheckoutBackground}>
            ...
            <LWTooltip title="Not available yet">
              <span
                className={classes.ctaDisabled}
                onClick={() => {
                  captureEvent("2019BookAmazonClicked");
                  window.open(
                    "https://smile.amazon.co.uk/Map-that-Reflects-Territory-LessWrong/dp/1736128507?sa-no-redirect=1",
                  );
                }}
              >
                Amazon UK (£25)
            ...
            <div className={classes.ctaSmallText}>
              <div className={classes.availabilityNotice}>Limited Stock</div>
              <Link
        ...
        <ContentStyles contentType="post" className={classNames(classes.body, classes.text1)}>
          <p>
            {lw()} is a community blog devoted to refining the art of human rationality. This book set is a collection
            of our best essays from 2019, as determined by our{" "}
            <Link to="/posts/kdGSTBj3NA2Go3XaE/2019-review-voting-results">Annual Review</Link>.
          </p>
          <p>
            It contains over 50 essays, packaged into a beautiful set of 4 books, which form the latest addition to the
            LessWrong canon.is a community blog devoted to refining the art of human rationality.
          </p>
        </ContentStyles>
        <img
          className={classes.spread1}
          src="https://39669.cdn.cke-cs.com/rQvD3VnunXZu34m86e5f/images/740b9c8f623b83765762da9ed63ca0e26d9b622da0c60db1.jpg/w_2800"
        />
        <img
          className={classes.bookStack}
          src="https://res.cloudinary.com/lesswrong-2-0/image/upload/v1639200627/risks-from-learned-optimization_yk7hpc.jpg"
        />
        <div className={classNames(classes.body, classes.text2)}>
          ...
          <p>
            Based on a starting image and a text prompt, the system attempts to transform the starting image into what
            it expects to find on the internet connected with the text of the prompt. Below is an animation showing
          ...
          <p>
            ...
            prompt for the first book was.{" "}
            <i>
              The Engines of Cognition by Alex Hillkurtz | System of Gears | Aquarelle | Greek Architecture | Blue on
              White Color Palette | Trending on Artstation
            </i>
            . The text prompt for each essay used the title of the essay.
          </p>
        </div>
        <div className={classes.spread2}>
          <div className={classes.videocontainer}>
            <video loop muted className={classes.video} autoPlay>
              <source
                src="https://res.cloudinary.com/lesswrong-2-0/video/upload/v1639001843/StraightOn_Compilation2_1_g7t4fy.mp4"
                type="video/mp4"
              />
            </video>
          </div>
