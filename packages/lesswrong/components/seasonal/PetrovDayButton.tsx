...
const PetrovDayButton = ({
  ...
  const afterPressMessage = disableLaunchButton ? (
    <p>You are not authorized to initiate a missile strike at this time. Try again later.</p>
  ) : (
    <p>enter launch code to initiate missile strike</p>
  );
          ...
          <div className={classes.panel}>
            <Typography variant="display1" className={classes.karmaThreshold}>
              <Link className={classes.karmaThreshold} to={"/posts/" + petrovPostIdSetting.get()}>
                ...
                <div
                  className={classes.usersAboveThreshold}
                >{`Users above threshold: ${usersAboveKarmaThresholdHardcoded20220922[currentKarmaThreshold]}`}</div>
              ...
              <div className={classes.button}>
                {renderButtonAsPressed ? (
                  <LWTooltip
                    title={
                      <div>
                        <div>You have pressed the button.</div>
                        <div>You cannot un-press it.</div>
                      </div>
                    }
                    placement="right"
                  >
            ...
            <div className={classes.inputSection}>
              ...
              <div className={classes.info}>{renderButtonAsPressed ? afterPressMessage : beforePressMessage}</div>
            </div>
