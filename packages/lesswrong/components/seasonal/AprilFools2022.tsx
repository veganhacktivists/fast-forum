...
export const AprilFools2022 = ({ classes }: { classes: ClassesType }) => {
  ...
  return (
    <SingleColumnSection>
      ...
      <div className={classes.row}>
        <div className={classes.column}>
          ...
          {results?.slice(0, 5).map((user, i) => (
            <div key={user._id} className={classNames(classes.userRow, classes.orange)}>
        ...
        <div className={classes.column}>
          ...
          {results?.slice(5, 10).map((user, i) => (
            <div key={user._id} className={classNames(classes.userRow, classes.yellow)}>
        ...
        <div className={classes.column}>
          ...
          {results?.slice(10, 15).map((user, i) => (
            <div key={user._id} className={classNames(classes.userRow, classes.green)}>
      ...
      <SectionFooter>
        <Link to="/posts/mz3hwS4c9bc9EHAm9/replacing-karma-with-good-heart-tokens-worth-usd1">
