...
const HorizScrollBlock = ({ children, classes }: { children: ReactNode; classes: ClassesType }) => {
  ...
  return (
    <div className={classes.scrollIndicatorWrapper}>
      ...
      />
      <div className={classes.scrollableContents} ref={scrollableContentsRef} onScroll={updateScrollBounds}>
        {children}
      </div>
      <div
        onClick={(_ev) => {
