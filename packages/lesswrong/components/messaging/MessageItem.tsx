 ...
 */
const MessageItem = ({ message, classes }: { message: messageListFragment; classes: ClassesType }) => {
  ...
  return (
    <div
      className={classNames(classes.root, {
        [classes.rootWithImages]: isFriendlyUI,
        [classes.rootCurrentUserWithImages]: isFriendlyUI && isCurrentUser,
      })}
    >
      {profilePhoto}
      <Components.Typography
        variant="body2"
        className={classNames(classes.message, { [classes.backgroundIsCurrent]: isCurrentUser })}
      >
