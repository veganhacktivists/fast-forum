...
const RecommendationsList = ({
  ...
  if (recommendationsLoading || !recommendations) return loadingFallback ?? <PostsLoading />;

  return (
    <div className={className}>
      {recommendations.map((post) => (
        <ListItem key={post._id} post={post} translucentBackground={translucentBackground} />
      ))}
