...
const RecommendationsPageCuratedList = ({ classes }: { classes: ClassesType }) => {
  ...
  return (
    <div>
      <AnalyticsContext pageContext={"curatedPage"}>
        ...
        {hasCuratedPostsSetting.get() && currentUser?.isAdmin && (
...
const RecommendationsPageCuratedListComponent = registerComponent(
