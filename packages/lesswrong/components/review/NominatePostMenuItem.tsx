...
const NominatePostMenuItem = ({ post, closeMenu }: { post: PostsBase; closeMenu: () => void }) => {
  ...
  const tooltip = nominated ? (
    <div>
      ...
      <div>
        <em>(Click to review or edit your endorsement)</em>
      </div>
    </div>
  ) : (
    ...
    <React.Fragment>
      <Tooltip title={tooltip} placement="left">
        <MenuItem onClick={handleClick}>
          <ListItemIcon>{nominated ? <StarIcon /> : <StarBorderIcon />}</ListItemIcon>
