...
export const NewLongformReviewForm = ({ classes }: { classes: ClassesType }) => {
    ...
    <div>
      {showText && (
        <div className={classes.text}>
          ...
          <p>
            Write a broader review, as a top-level post. This can cover a wide variety of "review shaped" thoughts,
            like:
          </p>
          <ul>
            ...
            <li>
              Any other meta-reflection on LessWrong, or how your thought processes have evolved in the past 2 years.
            </li>
          </ul>
          <p>
            If you're reviewing a specific single-post in depth, you should also write a short comment review linking to
            this post.
          </p>
          <Row justifyContent="flex-end">
            <Button className={classes.button} onClick={() => setShowText(false)}>
              Click to hide
            </Button>
          </Row>
        </div>
