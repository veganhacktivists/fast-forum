...
const Reviews2018 = ({ classes }: { classes: ClassesType }) => {
  ...
  const { SingleColumnSection, SectionTitle, PostsList2, SectionFooterCheckbox, RecentComments, LWTooltip, MenuItem } =
    Components;
    ...
    <div>
      <SingleColumnSection>
        ...
        <div className={classes.settings}>
          ...
          <Select value={sortNominatedPosts} onChange={(e) => setSortNominatedPosts(e.target.value)} disableUnderline>
