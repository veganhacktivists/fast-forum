...
const NominatePostDialog = ({
  ...
  return (
    <LWDialog open={true} onClose={onClose} fullWidth maxWidth="sm">
      <DialogTitle>
      ...
      <DialogContent>
        ...
        <Typography variant="body2" className={classes.text}>
          ...
          <Link className={classes.link} target="_blank" to={"/posts/QFBEjjAvT6KbaA3dY/the-lesswrong-2019-review"}>
