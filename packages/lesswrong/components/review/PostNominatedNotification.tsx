  ...
  return (
    <div className={classes.root}>
      ...
      <ContentStyles contentType="comment">
        ...
        <p>
          You're encouraged to write a self-review, exploring how you think about the post today. Do you still endorse
          it? Have you learned anything new that adds more depth? How might you improve the post? What further work do
          you think should be done exploring the ideas here?
        </p>
...
const PostNominatedNotificationComponent = registerComponent("PostNominatedNotification", PostNominatedNotification, {
  styles,
});
