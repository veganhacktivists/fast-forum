...
const ReviewVotingExpandedPost = ({
  classes,
  post,
  setExpandedPost,
          ...
          reviewMessage={
            <div>
              <div className={classes.writeAReview}>
                ...
                <div className={classes.fakeTextfield}>
...
const ReviewVotingExpandedPostComponent = registerComponent("ReviewVotingExpandedPost", ReviewVotingExpandedPost, {
  styles,
});
