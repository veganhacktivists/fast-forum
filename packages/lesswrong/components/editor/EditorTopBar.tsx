...
const EditorTopBar = ({
  ...
  return (
    <div className={classes.editorTopBar}>
      ...
      <span>
        <Select
          className={classes.collabModeSelect}
          disableUnderline
        ...
        >
          ...
          <MenuItem value="Commenting" key="Commenting" disabled={!canComment}>
          ...
          <MenuItem value="Editing" key="Editing" disabled={!canEdit}>
            Editing
            {canEditOnlyBecauseAdmin && " (admin override)"}
          </MenuItem>
          {post.collabEditorDialogue && (
            <MenuItem value="Editing (override)" key="Editing (override)" disabled={!canEdit}>
              Editing (override)
              {canEditOnlyBecauseAdmin && " (admin override)"}
            </MenuItem>
          )}
