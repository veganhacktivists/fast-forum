...
const PostVersionHistoryButton = ({
  post,
  postId,
  classes,
}: {
...
const PostVersionHistoryButtonComponent = registerComponent("PostVersionHistoryButton", PostVersionHistoryButton, {
  styles,
});
