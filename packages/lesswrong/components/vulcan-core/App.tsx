...
export const siteImageSetting = new DatabasePublicSetting<string>(
  "siteImage",
  "https://res.cloudinary.com/fast-forum/image/upload/v1706551810/vlqzlqumujk0zcceifrk.png",
...
const App = ({
  ...
  if (
    !subscribeLocationContext.current ||
