...
const RecentDiscussionThreadsList = ({
  ...
  const { SingleColumnSection, SectionTitle, SectionButton, ShortformSubmitForm, Loading, AnalyticsInViewTracker } =
    Components;
...
const RecentDiscussionThreadsListComponent = registerComponent(
