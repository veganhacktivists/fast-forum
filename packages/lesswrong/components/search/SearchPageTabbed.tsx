...
const Stats = ({ nbHits, className }: { nbHits: number; className: string }) => {
  return (
...
const SearchPageTabbed = ({ classes }: { classes: ClassesType }) => {
  ...
  const [tagsFilter, setTagsFilter] = useState<Array<string>>([query.tags ?? []].flatMap((tags) => tags));
  ...
  const {
    ...
    ExpandedPostsSearchHit,
    ExpandedCommentsSearchHit,
    ExpandedTagsSearchHit,
  ...
  const onSearchStateChange = (updatedSearchState: ExpandedSearchState) => {
    ...
    if (clearTagFilters) setTagsFilter([]);
  ...
  if (!isSearchEnabled()) {
    return <div className={classes.root}>Search is disabled (ElasticSearch not configured on server)</div>;
  }
      ...
      >
        ...
        <div className={classes.resultsColumn}>
            ...
            // @ts-ignore */}
              ...
              <div onClick={() => setModalOpen(true)}>
                <IconButton className={classes.funnelIconButton}>
                  <ForumIcon
                    icon="Funnel"
                    className={classNames({ [classes.funnelIconLW]: !isEAForum, [classes.funnelIconEA]: isEAForum })}
                  />
                </IconButton>
              </div>
            </div>
          ...
          >
            ...
            <Tab
              label={taggingNameIsSet.get() ? taggingNamePluralCapitalSetting.get() : "Tags and Wiki"}
              value="Tags"
            />
