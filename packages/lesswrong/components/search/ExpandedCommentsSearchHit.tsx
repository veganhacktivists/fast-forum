...
const ExpandedCommentsSearchHit = ({ hit, classes }: { hit: Hit<any>; classes: ClassesType }) => {
  ...
  return (
    <div className={classes.root} onClick={handleClick}>
      <Link to={url} className={classes.link} onClick={(e) => e.stopPropagation()}>
        {comment.postTitle && <div className={classes.title}>{comment.postTitle}</div>}
        {!comment.postTitle && comment.tagName && (
      ...
      <div className={classes.authorRow}>
        {comment.authorSlug ? (
          <Link to={userGetProfileUrlFromSlug(comment.authorSlug)} onClick={(e) => e.stopPropagation()}>
...
const ExpandedCommentsSearchHitComponent = registerComponent("ExpandedCommentsSearchHit", ExpandedCommentsSearchHit, {
  styles,
});
