...
const PostsListEditorSearchHit = ({ hit, classes }: { hit: Hit<AnyBecauseTodo>; classes: ClassesType }) => {
    ...
    <PostsTooltip postId={post._id} postsList placement="left">
      <div className={classes.root}>
        ...
        <div className={classes.metadataRow}>
          {post.authorDisplayName && <MetaInfo>{post.authorDisplayName}</MetaInfo>}
          <MetaInfo>{post.baseScore} karma</MetaInfo>
          {post.postedAt && (
            <MetaInfo>
...
const PostsListEditorSearchHitComponent = registerComponent("PostsListEditorSearchHit", PostsListEditorSearchHit, {
  styles,
});
