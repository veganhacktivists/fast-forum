...
const ExpandedSequencesSearchHit = ({ hit, classes }: { hit: Hit<any>; classes: ClassesType }) => {
    ...
    <div className={classes.root} style={style}>
      <div className={classes.body} onClick={handleClick}>
        <div className={classes.titleRow}>
          ...
          {sequence.authorSlug ? (
            <Link to={userGetProfileUrlFromSlug(sequence.authorSlug)} onClick={(e) => e.stopPropagation()}>
...
const ExpandedSequencesSearchHitComponent = registerComponent(
  "ExpandedSequencesSearchHit",
  ExpandedSequencesSearchHit,
  { styles },
);
