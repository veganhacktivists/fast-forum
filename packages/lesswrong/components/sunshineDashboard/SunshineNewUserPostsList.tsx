...
const SunshineNewUserPostsList = ({
  posts,
  user,
  classes,
}: {
      ...
      {newPosts.map((post) => (
        <div className={classes.post} key={post._id}>
          <div className={classes.row}>
            ...
            {hasRejectedContentSectionSetting.get() && (
...
const SunshineNewUserPostsListComponent = registerComponent("SunshineNewUserPostsList", SunshineNewUserPostsList, {
  styles,
});
