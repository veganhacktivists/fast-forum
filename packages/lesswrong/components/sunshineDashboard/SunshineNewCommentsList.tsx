...
const SunshineNewCommentsList = ({ terms, classes }: { terms: CommentsViewTerms; classes: ClassesType }) => {
...
const SunshineNewCommentsListComponent = registerComponent("SunshineNewCommentsList", SunshineNewCommentsList, {
  styles,
});
