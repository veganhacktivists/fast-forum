...
type SortingType =
  ...
  | "karma"
  | "lastMonthKarma"
  | "userSortByRateLimitCount";

const RecentlyActiveUsers = ({ classes }: { classes: ClassesType }) => {
  const {
    UsersReviewInfoCard,
    LoadMore,
    LWTooltip,
  ...
  const {
    results = [],
    loadMoreProps: recentlyActiveLoadMoreProps,
    refetch,
  } = useMulti({
        ...
        <div className={classNames(classes.tabButton, classes.recentlyActiveTab)}>
          ...
          <Row>
            <span className={classes.checkbox}>
              <SectionFooterCheckbox
                onClick={() => setIgnoreLowKarma(!ignoreLowKarma)}
                value={ignoreLowKarma}
      ...
      <table className={classes.table}>
        <thead className={classes.header}>
          <tr>
            ...
            <td>DisplayName</td>
            <td
              className={classNames(classes.cell, classes.numberCell, { [classes.selected]: sorting === "karma" })}
            ...
            <td
              className={classNames(classes.cell, classes.numberCell, {
                [classes.selected]: sorting === "last20Karma",
              })}
            ...
            <td
              className={classNames(classes.cell, classes.numberCell, {
                [classes.selected]: sorting === "lastMonthKarma",
              })}
            ...
            <td
              className={classNames(classes.cell, classes.numberCell, { [classes.selected]: sorting === "downvoters" })}
            ...
            <td
              className={classNames(classes.cell, classes.numberCell, {
                [classes.selected]: sorting === "lastNotificationsCheck",
              })}
            ...
            <td
              className={classNames(classes.cell, { [classes.selected]: sorting === "userSortByRateLimitCount" })}
            ...
            return (
              <React.Fragment key={`${user._id}`}>
                <tr key={user._id}>
                  ...
                  <td className={classes.numberCell}>
                    <LWTooltip title={downvoterTooltip(user)}>{downvoterCount}</LWTooltip>
                  </td>
                  <td>
                    <MetaInfo>
