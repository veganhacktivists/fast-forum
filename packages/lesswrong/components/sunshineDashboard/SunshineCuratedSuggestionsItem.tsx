...
const SunshineCuratedSuggestionsItem = ({ classes, post }: { classes: ClassesType; post: PostsList }) => {
    ...
    <span {...eventHandlers}>
      <Components.SunshineListItem hover={hover}>
        ...
        <div>
          ...
          {post.podcastEpisodeId && <Components.ForumIcon icon="VolumeUp" className={classes.audioIcon} />}
        </div>
        <Components.SidebarInfo>Endorsed by {post.suggestForCuratedUsernames}</Components.SidebarInfo>
        {hover && (
...
const SunshineCuratedSuggestionsItemComponent = registerComponent(
