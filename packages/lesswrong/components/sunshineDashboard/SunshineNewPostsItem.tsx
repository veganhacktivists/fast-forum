...
const SunshineNewPostsItem = ({
  ...
  const moderationSection =
    post.moderationStyle || post.user?.moderationStyle || modGuidelinesHtml || userGuidelinesHtml;
      ...
      <SunshineListItem hover={hover}>
        <SidebarHoverOver hover={hover} anchorEl={anchorEl}>
          ...
          <div className={classes.metaInfoRow}>
            ...
            {postGetCommentCount(post) && (
              <MetaInfo>
                <Link to={`${postGetPageUrl(post)}#comments`}>{postGetCommentCountStr(post)}</Link>
              </MetaInfo>
            )}
          </div>
          {moderationSection && (
            <div className={classes.moderation}>
              ...
              {(modGuidelinesHtml || userGuidelinesHtml) && (
                <div>
                  <MetaInfo>
        ...
        <Link to={postGetPageUrl(post)}>{post.title}</Link>
        <div>
          <SidebarInfo>{post.baseScore}</SidebarInfo>
          <SidebarInfo>
