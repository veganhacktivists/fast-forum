...
export const RejectedCommentsList = ({ classes }: { classes: ClassesType }) => {
  const [expanded, setExpanded] = useState(false);
  const { RejectedReasonDisplay, FormatDate, MetaInfo, PostsTooltip, CommentBody, Row, ForumIcon } = Components;
