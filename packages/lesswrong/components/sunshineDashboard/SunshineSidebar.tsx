    ...
    <div className={classes.root}>
      {showInitialSidebar && (
        <div className={classes.background}>
          ...
          {currentUser.groups?.includes("alignmentForumAdmins") && (
            <div>
              <AFSuggestPostsList />
              <AFSuggestCommentsList />
              <AFSuggestUsersList />
      ...
      {userCanDo(currentUser, "posts.moderate.all") && (
        <div>
          {showSidebar ? (
            <div className={classes.toggle} onClick={() => setShowSidebar(false)}>
              Hide Full Sidebar
      ...
      {showSidebar && userCanDo(currentUser, "posts.moderate.all") && (
        <div>
          {!!currentUser!.viewUnreviewedComments && (
            <SunshineNewCommentsList terms={{ view: "sunshineNewCommentsList" }} />
          )}
      ...
      {showSidebar && (
        <div>
          {showUnderbelly ? (
            <div className={classes.toggle} onClick={() => setShowUnderbelly(false)}>
              Hide {underbellyName}
              <KeyboardArrowDownIcon />
            </div>
          ) : (
