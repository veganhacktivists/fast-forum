...
const UserDisplay = ({ column, document }: { column: Column; document: any }) => {
...
const PostDisplay = ({ column, document }: { column: Column; document: any }) => {
...
const CommentDisplay = ({ column, document }: { column: Column; document: any }) => {
  const mainTextHtml = sanitizeHtml(document.contents.html, {
...
const DateDisplay = ({ column, document }: { column: Column; document: any }) => {
...
const ModGPTDashboard = ({ classes }: { classes: ClassesType }) => {
