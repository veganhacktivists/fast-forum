...
export const SunshineUserMessages = ({
  classes,
  user,
  currentUser,
}: {
  ...
  return (
    <div className={classes.root}>
        ...
        <div key={conversation._id}>
          <LWTooltip title={`${conversation.messageCount} messages in this conversation`}>
            <Link to={`/inbox/${conversation._id}`}>
              <MetaInfo>
                <EmailIcon className={classes.icon} /> {conversation.messageCount}
              </MetaInfo>
              <span className={classes.title}>
                ...
                {conversation.participants
                  ...
                  .map((participant) => {
                    return (
                      <MetaInfo key={`${conversation._id}${participant._id}`}>
      ...
      <SunshineSendMessageWithDefaults user={user} embedConversation={embedConversation} />
