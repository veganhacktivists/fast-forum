...
const SunshineCuratedSuggestionsList = ({
  terms,
  belowFold,
  classes,
}: {
  ...
  const { SunshineListTitle, SunshineCuratedSuggestionsItem, MetaInfo, FormatDate, LoadMore, LWTooltip, ForumIcon } =
    Components;
  ...
  return (
    <div className={classes.root}>
      ...
      {showLoadMore && (
        <div className={classes.loadMorePadding}>
...
const SunshineCuratedSuggestionsListComponent = registerComponent(
