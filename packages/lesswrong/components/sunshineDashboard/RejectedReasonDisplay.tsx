...
export const RejectedReasonDisplay = ({ classes, reason }: { classes: ClassesType; reason: string | null }) => {
  ...
  return (
    <span className={classes.root}>
      ...
      >
        <MetaInfo className={classes.shortReason}>{getShortRejectedReason(reason)}</MetaInfo>
      </LWTooltip>
    </span>
  );
};
