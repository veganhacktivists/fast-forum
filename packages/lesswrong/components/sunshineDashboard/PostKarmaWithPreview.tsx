...
const PostKarmaWithPreview = ({
  ...
  return (
    <PostsTooltip post={post} placement={displayTitle ? "right-start" : "bottom-start"} clickable>
      <span
      ...
      >
        ...
        >
          ...
          <span className={displayTitle ? classes.scoreTitleFormat : undefined}>{post.baseScore}</span>
