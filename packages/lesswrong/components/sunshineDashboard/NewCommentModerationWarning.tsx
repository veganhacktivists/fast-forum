...
const commentModerationWarningCommentIdSetting = new DatabasePublicSetting<string>(
  "commentModerationWarningCommentId",
  "",
);
...
export const NewCommentModerationWarning = ({ classes }: { classes: ClassesType }) => {
  ...
  return (
    <div className={classes.root}>
      <ContentStyles contentType="comment" className={classes.modNote}>
        ...
        {!html && !loading && (
          <div>
            <em>A moderator will need to review your account before your comments will appear publicly.</em>
          </div>
        )}
      </ContentStyles>
    </div>
...
const NewCommentModerationWarningComponent = registerComponent(
