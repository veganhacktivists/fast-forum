...
const DialoguesSectionFrontpageSettings = ({
  hidden,
  currentShowDialogues,
  currentShowMyDialogues,
  currentShowMatches,
  currentShowRecommendedPartners,
  hideReciprocityButtons,
  classes,
}: {
  hidden: boolean;
  ...
  return (
    <div className={classNames(classes.root, { [classes.hidden]: hidden })}>
      {!hideReciprocityButtons && (
        <Tooltip title="People you matched with on dialogue matching">
      ...
      {!hideReciprocityButtons && (
        <Tooltip title="Recommended partners for you to consider dialogueing with">
          <div className={classes.setting}>
            <Checkbox
              style={{ padding: 7 }}
