  ...
  return (
    <div className={classes.root} {...eventHandlers}>
      ...
      >
        ...
        {!hideParentCommentToggle && parentCommentId != comment.parentCommentId && (
          <span className={classes.parentComment}>
            <ShowParentComment comment={comment} />
          </span>
        )}
        {!hideKarma && <span className={classes.karma}>{commentGetKarma(comment)}</span>}
        <CommentUserName comment={comment} simple className={classes.username} />
        {!hideSingleLineMeta && (
        ...
        {renderHighlight && (
          <ContentStyles contentType="comment" className={classes.truncatedHighlight}>
            ...
            {comment.nominatedForReview && !hideSingleLineMeta && (
              <span className={classes.metaNotice}>Nomination</span>
            )}
        ...
        {showDescendentCount && comment.descendentCount > 0 && (
          <PostsItemComments
            small={true}
