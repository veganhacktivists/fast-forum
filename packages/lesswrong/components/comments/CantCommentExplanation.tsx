...
const CantCommentExplanation = ({ post, classes }: { post: PostsDetails; classes: ClassesType }) => {
...
const CantCommentExplanationComponent = registerComponent("CantCommentExplanation", CantCommentExplanation, { styles });
