...
const ModerationGuidelinesEditForm = ({
  commentType = "post",
  documentId,
  onClose,
  classes,
  ...
  return (
    <Components.LWDialog open={true} onClose={onClose}>
      <DialogTitle>Moderation Guidelines Edit Form</DialogTitle>
      <DialogContent>
...
const ModerationGuidelinesEditFormComponent = registerComponent(
  "ModerationGuidelinesEditForm",
  ModerationGuidelinesEditForm,
  { styles },
);
