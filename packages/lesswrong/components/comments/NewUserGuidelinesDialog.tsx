...
const firstCommentAcknowledgeMessageCommentIdSetting = new DatabasePublicSetting<string>(
  "firstCommentAcknowledgeMessageCommentId",
  "",
);
  ...
  return (
    <AnalyticsContext pageSectionContext="firstCommentAcknowledgeDialog">
      <LWDialog open={true}>
        ...
        <DialogActions>
          {isLW && <Button>This was your father's rock</Button>}
          <Button onClick={handleClick}>I have read and understood</Button>
        </DialogActions>
      </LWDialog>
    </AnalyticsContext>
  );
...
const NewUserGuidelinesDialogComponent = registerComponent("NewUserGuidelinesDialog", NewUserGuidelinesDialog, {
  styles,
});
