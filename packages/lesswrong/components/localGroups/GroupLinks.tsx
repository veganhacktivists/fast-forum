...
export const FacebookIcon = (props: any) => (
  <SvgIcon viewBox="0 0 155.139 155.139" {...props}>
    <path
      id="f_1_"
...
export const RoundFacebookIcon = (props: any) => (
  <SvgIcon viewBox="0 0 24 24" {...props}>
    <path d="M12 0c-6.627 0-12 5.373-12 12s5.373 12 12 12 12-5.373 12-12-5.373-12-12-12zm3 8h-1.35c-.538 0-.65.221-.65.778v1.222h2l-.209 2h-1.791v7h-3v-7h-2v-2h2v-2.308c0-1.769.931-2.692 3.029-2.692h1.971v3z" />
  </SvgIcon>
);

export const MeetupIcon = (props: any) => (
  <SvgIcon viewBox="15 15 70 70" {...props}>
    <path
...
export const SlackIcon = (props: any) => (
  <SvgIcon viewBox="70 70 130 130" {...props}>
    <g>
      <g>
...
const GroupLinks = ({
  ...
  return (
    <div className={classes.root}>
        ...
        <div className={noMargin ? classNames(classes.groupTypes, classes.noMargin) : classes.groupTypes}>
          {document.types &&
            document.types.map((type) => {
              return (
                <Tooltip title={tooltips[type]} placement="top-end" key={type}>
                  <div className={classes.groupType}>{type}</div>
                </Tooltip>
              );
            })}
        </div>
      ...
      <div
        className={
          noMargin && (isEAForum || !document.types?.length)
            ? classNames(classes.groupLinks, classes.noMargin)
            : classes.groupLinks
        }
      >
        {document.facebookLink && (
          <Tooltip title={`Link to Facebook ${isEvent ? "Event" : "Group"}`} placement="top-end">
        ...
        {"facebookPageLink" in document && document.facebookPageLink && (
          <Tooltip title={`Link to Facebook ${isEvent ? "Event" : "Page"}`} placement="top-end">
