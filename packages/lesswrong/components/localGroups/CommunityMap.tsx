...
const CommunityMap = ({
  ...
  const groupQueryTerms: LocalgroupsViewTerms = groupTerms || {
    view: "all",
  ...
  const renderedMarkers = useMemo(() => {
    return (
      <React.Fragment>
        ...
        {showUsers && (
          <Components.PersonalMapLocationMarkers
            users={users}
            handleClick={handleClick}
            handleClose={handleClose}
            openWindows={openWindows}
        ...
        {!hideLegend && (
          <div className={classes.mapButtons}>
            <Components.CommunityMapFilter
              ...
              toggleEvents={() => setShowEvents(!showEvents)}
...
const PersonalMapLocationMarkers = ({
  users,
  handleClick,
  handleClose,
  openWindows,
      ...
      {users.map((user) => {
        ...
        return (
          <React.Fragment key={user._id}>
            <Marker latitude={lat} longitude={lng} offsetLeft={-8} offsetTop={-20}>
