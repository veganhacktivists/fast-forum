...
const EventNotificationsDialog = ({ onClose, classes }: { onClose: () => void; classes: ClassesType }) => {
  ...
  const [label, setLabel] = useState(
    nearbyEventsNotificationsLocation?.formatted_address ||
    ...
    <LWDialog open={true} onClose={onClose}>
      ...
      <DialogContent>
        <Typography variant="body2">
          <p>Notify me of events and new groups in this location</p>
        </Typography>
        ...
        <FormLabel className={classes.distanceHeader} component={"legend" as any}>
          Notification Radius
        </FormLabel>
        <div className={classes.distanceSection}>
          ...
          <Input
            ...
            endAdornment={
              <InputAdornment disableTypography className={classes.inputAdornment} position="end">
                km
              </InputAdornment>
            }
            onBlur={() =>
              setDistance(distance > MAX_NOTIFICATION_RADIUS ? MAX_NOTIFICATION_RADIUS : distance < 0 ? 0 : distance)
            }
            inputProps={{
              step: MAX_NOTIFICATION_RADIUS_STEPSIZE,
              min: 0,
...
const EventNotificationsDialogComponent = registerComponent("EventNotificationsDialog", EventNotificationsDialog, {
  styles,
});
