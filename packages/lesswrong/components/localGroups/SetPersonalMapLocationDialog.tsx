...
const SetPersonalMapLocationDialog = ({ onClose, classes }: { onClose: () => void; classes: ClassesType }) => {
  ...
  useEffect(() => {
    const defaultMapMarkerText =
      currentUserWithMarkdownBio?.mapMarkerText || currentUserWithMarkdownBio?.biography?.markdown || "";
  ...
  return (
    <LWDialog open={true} onClose={onClose}>
      <DialogTitle>Add your location to the map</DialogTitle>
      <DialogContent>
        <Typography variant="body2">This information will be publicly visible</Typography>
...
const SetPersonalMapLocationDialogComponent = registerComponent(
