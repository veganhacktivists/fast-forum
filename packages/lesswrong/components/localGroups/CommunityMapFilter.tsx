...
const CommunityMapFilter = ({
  ...
  const GroupIcon = () =>
    isEAForum ? <StarIcon className={classes.eaButtonIcon} /> : <GroupIconSVG className={classes.buttonIcon} />;
  const EventIcon = () =>
    isEAForum ? <RoomIcon className={classes.eaButtonIcon} /> : <ArrowSVG className={classes.buttonIcon} />;
  const PersonIcon = () =>
    isEAForum ? <PersonPinIcon className={classes.eaButtonIcon} /> : <PersonSVG className={classes.buttonIcon} />;
    ...
    <Paper>
      ...
      <div className={classes.actions}>
        <div className={classes.filterSection}>
          ...
          <span
            className={classNames(classes.mobileFilter, { [classes.mobileFilterActive]: !showGroups })}
          ...
          <span className={classes.actionContainer}>
            ...
            <Tooltip title="Hide groups from map">
              <VisibilityIcon
                onClick={toggleGroups}
                className={classNames(classes.actionIcon, classes.visibilityIcon, {
                  [classes.checkedVisibilityIcon]: !showGroups,
                })}
              />
            </Tooltip>
          </span>
        ...
        <div className={classes.filterSection}>
          ...
          <span
            className={classNames(classes.mobileFilter, { [classes.mobileFilterActive]: !showEvents })}
          ...
          <span className={classes.actionContainer}>
            ...
            <Tooltip title="Hide events from map">
              <VisibilityIcon
                onClick={toggleEvents}
                className={classNames(classes.actionIcon, classes.visibilityIcon, {
                  [classes.checkedVisibilityIcon]: !showEvents,
                })}
              />
            </Tooltip>
          </span>
        ...
        <div className={classes.filterSection}>
          ...
          <span
            className={classNames(classes.mobileFilter, { [classes.mobileFilterActive]: !showIndividuals })}
          ...
          <span className={classes.actionContainer}>
            ...
            <Tooltip title="Hide individual user locations from map">
              <VisibilityIcon
                onClick={toggleIndividuals}
                className={classNames(classes.actionIcon, classes.visibilityIcon, {
                  [classes.checkedVisibilityIcon]: !showIndividuals,
                })}
              />
            </Tooltip>
          </span>
        ...
        <span>
          <Tooltip title="Hide the map from the frontpage">
            <div className={classNames(classes.filterSection, classes.hideSection)}>
              ...
              <span className={classNames(classes.buttonText, classes.hideText)} onClick={handleHideMap}>
                Hide Map
              </span>
            </div>
          </Tooltip>
...
const CommunityMapFilterComponent = registerComponent("CommunityMapFilter", CommunityMapFilter, { styles });
