...
const CommentOnYourDraftNotificationHover = ({
  notification,
  classes,
}: {
  ...
  return (
    <div className={classes.root}>
      <div>
        ...
        <Link to={postEditUrl}>{post ? post.title : <Loading />}</Link>
      </div>
...
const CommentOnYourDraftNotificationHoverComponent = registerComponent(
  "CommentOnYourDraftNotificationHover",
  CommentOnYourDraftNotificationHover,
  { styles },
);
