...
const MigrationsDashboardRow = ({
  migration: { name, dateWritten, runs, lastRun },
  classes,
}: {
  migration: any;
  classes: ClassesType;
  ...
  const toggleExpanded = React.useCallback((ev) => setExpanded(!expanded), [expanded, setExpanded]);
...
const MigrationsDashboardRowComponent = registerComponent("MigrationsDashboardRow", MigrationsDashboardRow, {
  styles,
});
