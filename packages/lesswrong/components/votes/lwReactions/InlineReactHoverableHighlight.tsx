...
const InlineReactHoverableHighlight = ({
  quote,
  reactions,
  voteProps,
  children,
  ...
  const isHovered =
    hoveredReactions && Object.keys(reactions).some((reaction) => hoveredReactions.find((r) => r === reaction));
  ...
  return (
    <LWTooltip
      title={<InlineReactHoverInfo quote={quote} reactions={reactions} voteProps={voteProps} />}
      placement="top-start"
      tooltip={false}
      flip={false}
      inlineBlock={false}
...
const InlineReactHoverableHighlightComponent = registerComponent(
