  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <OverallVoteButton orientation="up" color="secondary" upOrDown="Upvote" enabled={canVote} {...voteProps} />
        </div>
      </Tooltip>
      <div
        className={classNames({
      ...
      >
        ...
        {!!post.af && !!post.afBaseScore && !isAF && (
          <Tooltip title="AI Alignment Forum karma" placement={tooltipPlacement} classes={{ tooltip: classes.tooltip }}>
            <Typography
              variant="headline"
      ...
      >
        ...
        >
          <OverallVoteButton orientation="down" color="error" upOrDown="Downvote" enabled={canVote} {...voteProps} />
        </div>
      </Tooltip>
    </div>
  );
...
const PostsVoteDefaultComponent = registerComponent("PostsVoteDefault", PostsVoteDefault, { styles });
