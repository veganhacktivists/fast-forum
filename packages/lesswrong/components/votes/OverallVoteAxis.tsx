...
const OverallVoteAxis = ({
  ...
  const voteCount =
    extendedScore && "approvalVoteCount" in extendedScore ? extendedScore.approvalVoteCount : voteProps.voteCount || 0;
  ...
  return (
    <TooltipIfDisabled>
      <span className={classes.vote}>
        ...
        {!af && isAF && (
          <LWTooltip title="LessWrong Karma" placement={tooltipPlacement} className={classes.tooltip}>
            <span className={classes.secondaryScore}>
