...
export const CollectionTableOfContents = ({
  classes,
  collection,
}: {
  classes: ClassesType;
  ...
  return <TableOfContents sectionData={sectionData} title={collection.title} />;
};

const CollectionTableOfContentsComponent = registerComponent("CollectionTableOfContents", CollectionTableOfContents, {
  styles,
});
