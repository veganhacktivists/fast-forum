...
const AddDraftPostDialog = ({
  ...
  return (
    <LWDialog open={true} onClose={onClose}>
      <DialogTitle>Add Draft Post</DialogTitle>
      <DialogContent>
...
const AddDraftPostDialogComponent = registerComponent("AddDraftPostDialog", AddDraftPostDialog);
