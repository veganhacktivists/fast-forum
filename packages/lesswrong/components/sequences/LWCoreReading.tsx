...
const coreReadingCollections: Array<CoreReadingCollection> = [
  ...
  },
  {
    ...
    imageUrl:
      "https://res.cloudinary.com/lesswrong-2-0/image/upload/c_crop,g_custom/c_fill,dpr_auto,q_auto,f_auto,g_auto:faces,w_auto,h_280/sequences/rdl8pwokejuqyxipg6vx",
    color: "#757AA7",
    url: "/highlights",
  },
  {
    ...
    imageUrl:
      "https://res.cloudinary.com/lesswrong-2-0/image/upload/v1657774172/DALL_E_2022-07-13_21.49.04_-_11_year_old_wizard_boy_with_short_messy_black_hair_and_glasses_standing_upright_looking_intently_at_the_camera_casting_a_question_spell_glowing_wh_l1ls1k.png",
    color: "#757AA7",
    url: "/hpmor",
  },
  {
    ...
    summary:
      "<div>Essays by Scott Alexander exploring science, medicine, philosophy, futurism, and politics. (There's also one about hallucinatory cactus people but it's not representative).</div>",
  ...
  },
  {
    ...
    userId: "nmk3nLpQE89dMRzzN",
    summary:
      "<div>Each December, the LessWrong community reviews the best posts from the previous year, and votes on which ones have stood the tests of time.</div>",
    ...
    imageUrl:
      "https://res.cloudinary.com/lesswrong-2-0/image/upload/v1657778273/DALL_E_2022-07-13_22.57.43_-_Books_and_emerald_compass_displayed_on_a_pedastal_aquarelle_painting_by_da_vinci_and_thomas_shaler_magic_the_gathering_concept_art_as_digital_art_ayufzo.png",
    color: "#757AA7",
    url: "/bestoflesswrong",
  },
];

const LWCoreReading = ({ classes }: { minimal?: boolean; classes: ClassesType }) => {
  const { SingleColumnSection, CollectionsItem } = Components;

  return (
    <SingleColumnSection className={classes.root}>
      {coreReadingCollections.map((collection) => (
