...
const SubforumSubforumTab = ({
  ...
  const sortBy: CommentSortingMode = ((sortByOptions.includes(query.sortedBy) && query.sortedBy) ||
    (sortByOptions.includes(tag.postsDefaultSortOrder) && tag.postsDefaultSortOrder) ||
    defaultSubforumSorting) as CommentSortingMode;
        ...
        renderers={{
          tagSubforumPosts: {
            ...
            render: (post: PostsRecentDiscussion) => {
              ...
              return (
                !(post._id === tag.subforumIntroPost?._id && !hideIntroPost) && (
                  <div className={classes.feedPostWrapper}>
                    <RecentDiscussionThread
                      key={post._id}
                      post={{ ...post }}
...
const SubforumSubforumTabComponent = registerComponent("SubforumSubforumTab", SubforumSubforumTab, { styles });
