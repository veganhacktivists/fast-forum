...
const TagHistoryPage = ({ classes }: { classes: ClassesType }) => {
          ...
          renderers={{
                ...
                return (
                  <SingleLineFeedEvent>
                    ...
                    {application.user && (
                      <>
                        {" "}
                        by <UsersName user={application.user} />
                      </>
                    )}{" "}
            ...
            tagDiscussionComment: {
              ...
              render: (comment: CommentsList) => (
                <div>
                  <CommentsNode treeOptions={{ tag }} comment={comment} loadChildrenSeparately={true} />
                </div>
              ),
            },
          }}
