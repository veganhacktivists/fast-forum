...
const TagProgressBar = ({ classes }: { classes: ClassesType }) => {
    ...
    <div className={classes.root}>
      <div className={classes.inner}>
        <div className={classes.text}>
          ...
          <PostsItem2MetaInfo>
            <Link
              className={classes.allTagsBarColor}
              to={"/posts/ELN6FpRLoeLJPgx8z/importing-the-old-lw-wiki-help-wanted"}
            >
              What's the Import?
            </Link>
            <SeparatorBullet />
          ...
          <LWTooltip
            title={
              <div>
                ...
                <div>
                  <em>(Click through to read posts, and then tag them)</em>
                </div>
              </div>
            }
          ></LWTooltip>
        </div>
        {
          <LWTooltip className={classes.tooltip} title={allPostsTooltip}>
            <LinearProgress classes={{ root: classes.barRoot }} variant="determinate" value={100} />
          </LWTooltip>
        }
        <div className={classes.secondaryInfo}>
          ...
          <LWTooltip title={"Hide this progress bar from the frontpage"}>
            <a className={classes.hideButton} onClick={hideClickHandler}>
              Hide
            </a>
          </LWTooltip>
        </div>
...
const TagProgressBarComponent = registerComponent("TagProgressBar", TagProgressBar, {
  styles,
