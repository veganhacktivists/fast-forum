...
const ChangeMetricsDisplay = ({
  ...
  return (
    <span className={classNames(classes.root, className)}>
      ...
      {added > 0 && removed === 0 && (
        <span className={classes.charsAdded}>
          (+{added}
          {characters})
        </span>
      )}
      {added === 0 && removed > 0 && (
        <span className={classes.charsRemoved}>
          (-{removed}
          {characters})
        </span>
      )}
...
const ChangeMetricsDisplayComponent = registerComponent("ChangeMetricsDisplay", ChangeMetricsDisplay, {
  styles,
  stylePriority: -1,
});
