...
const TagTooltipWrapper = ({
  ...
  const popperCardToRender =
    popperCard ?? (tagRel ? <TagRelCard tagRel={tagRel} /> : <TagPreview tag={tag} postCount={tag.postCount} />);
...
const TagTooltipWrapperComponent = registerComponent("TagTooltipWrapper", TagTooltipWrapper);
