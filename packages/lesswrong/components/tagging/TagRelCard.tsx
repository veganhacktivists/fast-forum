...
const TagRelCard = ({
  ...
  const TooltipIfDisabled = canVote
    ...
    : ({ children }: { children: React.ReactNode }) => (
        <LWTooltip placement="top" title={whyYouCantVote}>
          {children}
        </LWTooltip>
      );
    ...
    <div>
      <div className={classes.relevance}>
        <LWTooltip title="How relevant is this tag to this post?" placement="top">
          <span className={classes.relevanceLabel}>Relevance</span>
        </LWTooltip>
        <TooltipIfDisabled>
        ...
        {newlyVoted && (
          <span className={classes.removeButton}>
            <LWTooltip title={`Remove your relevance vote from this ${taggingNameSetting.get()}`} placement="top">
              <TagRelevanceButton
