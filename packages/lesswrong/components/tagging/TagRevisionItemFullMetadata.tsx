...
const TagRevisionItemFullMetadata = ({
  tag,
  revision,
  classes,
}: {
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.metadata}>
        ...
        <SmallSideVote document={revision} collection={Revisions} /> {revision.commitMessage}
      </div>
    </div>
  );
};

const TagRevisionItemFullMetadataComponent = registerComponent(
