...
export const useTagPreview = (
  ...
  queryOptions?: Partial<
    Omit<UseMultiOptions<TagPreviewFragmentName, "Tags">, "extraVariables" | "extraVariablesValues">
  >,
): {
  ...
  const hashVariables = hash ? { extraVariables: { hash: "String" }, extraVariablesValues: { hash } } : {};
