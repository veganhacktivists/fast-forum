...
const TagDiscussionPage = ({ classes }: { classes: ClassesType }) => {
  ...
  return (
    <SingleColumnSection>
      ...
      <ContentStyles contentType="comment" className={classes.description}>
        Discuss the {taggingNameIsSet.get() ? taggingNameSetting.get() : "wiki-tag"} on this page. Here is the place to
        ask questions and propose changes.
      </ContentStyles>
      {tag && <TagDiscussionSection tag={tag} />}
    </SingleColumnSection>
  );
};
