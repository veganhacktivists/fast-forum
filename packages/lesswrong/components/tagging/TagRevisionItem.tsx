...
const TagRevisionItem = ({
  ...
  if (collapsed && !expanded) {
    return (
      <Components.SingleLineFeedEvent expands setExpanded={setExpanded}>
  ...
  return (
    <div className={classNames({ [classes.container]: !noContainer })}>
      {headingStyle === "full" && <TagRevisionItemFullMetadata tag={tag} revision={revision} />}
      ...
      {!!(added || removed || !previousRevision) && (
...
const TagRevisionItemComponent = registerComponent("TagRevisionItem", TagRevisionItem, {
  styles,
