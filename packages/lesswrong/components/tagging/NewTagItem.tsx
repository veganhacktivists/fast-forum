...
const NewTagItem = ({ tag, classes }: { tag: TagCreationHistoryFragment; classes: ClassesType }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <div className={classes.metadata}>
        New {tag.wikiOnly ? "wiki page" : "tag"} created by <UsersName user={tag.user} /> at{" "}
      ...
      {!tag.wikiOnly && <PostsList2 terms={postSearchTerms} enableTotal tagId={tag._id} itemsPerPage={20} />}
