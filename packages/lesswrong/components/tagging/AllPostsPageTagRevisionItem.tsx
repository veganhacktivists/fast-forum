...
const styles = (theme: ThemeType): JssStyles => ({
  root: {
    ...
    borderRight: "none",
    borderRadius: isFriendlyUI ? `${theme.borderRadius.default}px 0 0 ${theme.borderRadius.default}px` : "2px 0 0 2px",
    padding: 12,
    marginLeft: 8,
    marginBottom: 16,
  },
...
const AllPostsPageTagRevisionItem = ({
  tag,
  revisionId,
  documentId,
  classes,
...
const AllPostsPageTagRevisionItemComponent = registerComponent(
