...
const EAUsersMetaInfo = ({ user, classes }: { user: UsersProfile; classes: ClassesType }) => {
  ...
  return (
    <ContentStyles contentType="comment" className={classes.iconsRow}>
      ...
      <span className={classes.userMetaInfo}>
        ...
        <span>
          Joined <FormatDate date={user.createdAt} format={"MMM YYYY"} />
        </span>
      </span>
...
const EAUsersMetaInfoComponent = registerComponent("EAUsersMetaInfo", EAUsersMetaInfo, { styles });
