...
const EAUsersProfileTabbedSection = ({ tabs, classes }: { tabs: Array<UserProfileTabType>; classes: ClassesType }) => {
  ...
  if (activeTab.collapsable) {
    tabBody = (
      <>
        <div
          className={classNames(classes.collapsableTabBody, {
            [classes.collapsedTabBody]: collapsed && meritsCollapse,
          })}
          ref={bodyRef}
        >
          {activeTab.body}
        ...
        {meritsCollapse &&
          (collapsed ? (
            <Button
              variant="outlined"
              color="primary"
              className={classes.toggleCollapsedBtn}
  ...
  return (
    <div className={classes.section}>
      <div className={classes.tabsRow}>
        ...
        <div className={classes.tabRowAction}>{activeTab.secondaryNode}</div>
      </div>
      {tabBody}
    </div>
  );
