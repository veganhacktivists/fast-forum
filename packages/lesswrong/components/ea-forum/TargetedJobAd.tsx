    ...
    getDescription: (classes: ClassesType) => (
      <>
        <div className={classes.description}>
          ...
          's first Senior Malaria Researcher will be responsible for strengthening the quality of the research and
          cost-effectiveness modeling guiding GiveWell's investments in{" "}
...
const TargetedJobAd = ({
  ...
  let ctaSection = (
    <>
      <div className={classes.prompt}>
        If you're interested in this role, would you like us to pass along your email address and FAST Forum profile to
        the hiring manager?
      </div>
  ...
  if (showUninterestedForm) {
    ctaSection = (
      <form onSubmit={handleSubmitUninterestedReason}>
        <div className={classes.prompt}>Why doesn't this role match your interests?</div>
        <div className={classes.btnRow}>
      ...
      <div className={classes.bodyCol}>
        <div className={classes.topRow}>
          <div className={classes.label}>
            <div className={classes.labelText}>Job recommendation</div>
            {/* <LWTooltip title={
        ...
        <h2 className={classes.header}>
          ...
          at{adData.insertThe ? " the" : ""}{" "}
          <span className={classes.link}>
            <HoverPreviewLink href={adData.orgLink}>{adData.org}</HoverPreviewLink>
          </span>
        </h2>
        <div className={classes.metadataRow}>
          {adData.salary && <div className={classes.metadata}>{adData.salary}</div>}
          ...
          )}
          {
            ...
            adData.deadline && moment().add(2, "days").isSameOrAfter(adData.deadline, "day") && (
        ...
        {!expanded ? (
          <button onClick={handleExpand} className={classes.readMore}>
            <ChevronRight className={classes.readMoreIcon} /> Expand
          </button>
        ) : (
          <button onClick={() => setExpanded(false)} className={classes.readMore}>
