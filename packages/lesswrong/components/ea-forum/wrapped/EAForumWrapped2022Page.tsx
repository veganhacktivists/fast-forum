...
const EAForumWrapped2022Page = ({ classes }: { classes: ClassesType }) => {
  ...
  const { SingleColumnSection, Typography, HoverPreviewLink, PostsByVoteWrapper, LoginForm, LWTooltip, Loading } =
    Components;
  ...
  if (showAnimation) {
    const gifName =
      theme.name === "dark" ? "v1672178471/wrapped_gif_v3_dark_mode.gif" : "v1672178471/wrapped_gif_v3_light_mode.gif";
    return (
      <div className={classes.loading}>
        <img
          src={`https://res.cloudinary.com/cea/image/upload/c_crop,w_250,h_250/${gifName}`}
      ...
      <div className={classes.root}>
        <SingleColumnSection>
          <div className={classes.summaryCard}>
              ...
              <div className={classes.summaryData}>
                <div className={classes.summaryDataLabel}>
                  ...
                  <div>
                    Your EA Forum{" "}
                    <a
                      href="https://en.wikipedia.org/wiki/Alignment_(Dungeons_%26_Dragons)#Alignments"
                      target="_blank"
                ...
                <div className={classes.summaryDataVal}>{results?.alignment}</div>
              </div>
            </div>
            ...
            {hasReadContent && (
              <>
                ...
                <div className={classes.summarySection}>
                    ...
                    <div className={classes.summaryData}>
                      ...
                      <div>
                        {results.mostReadAuthors.map((author: AnyBecauseTodo) => {
                          return (
                            <div key={author.slug} className={classes.summaryDataVal}>
                              <Link to={`/users/${author.slug}?from=2022_wrapped`} className={classes.link}>
                                {author.displayName}
                              </Link>
                              <span className={classes.count}>
                  ...
                  {results.mostReadTopics?.length > 0 && (
                    <AnalyticsContext pageSectionContext="mostReadTopics">
                      <div className={classes.summaryData}>
                        <div className={classes.summaryDataLabel}>
                          <TopicIcon className={classes.labelIcon} />
                          Your favorite topics{" "}
                          <LWTooltip title="We've disqualified Community from this stat because it gets applied to a lot of posts, and doesn't function like other topics.">
                        ...
                        <div>
                          {results.mostReadTopics.map((topic: AnyBecauseTodo) => {
                            return (
                              <div key={topic.slug} className={classes.summaryDataVal}>
                                <span className={classes.link}>
                                  <HoverPreviewLink href={`/topics/${topic.slug}`}>{topic.name}</HoverPreviewLink>
                                </span>
                                <span className={classes.count}>
                                  {topic.count} post{topic.count === 1 ? "" : "s"} read
                                </span>
                              </div>
                            );
                          })}
            ...
            {hasPublishedContent && (
              <>
                <h2 className={classes.summarySectionTitleRow}>
                  <div className={classes.summarySectionTitle}>You joined the conversation this year</div>
                </h2>
                <div className={classes.summarySection}>
                  {results.topPost && (
                    <AnalyticsContext pageSectionContext="topPost">
                      <div className={classes.summaryData}>
                        ...
                        <div className={classes.summaryDataVal}>
                          <span className={classes.link}>
                            <HoverPreviewLink href={`/posts/${results.topPost._id}/${results.topPost.slug}`}>
                  ...
                  {results.topShortform && (
                    <AnalyticsContext pageSectionContext="topShortform">
                      <div className={classes.summaryData}>
                        <div className={classes.summaryDataLabel}>
          ...
          <>
            <SingleColumnSection>
              <div className={classes.textSection}>
                <Typography variant="headline" className={classes.sectionHeadline}>
                  Take a moment to reflect on 2022
                </Typography>
                <Typography variant="body2" className={classes.body}>
                  Look back at everything you enjoyed reading - what did you find most valuable? Your answers will help
                  us encourage more of the most valuable content.
                </Typography>
              </div>
            </SingleColumnSection>
        ...
        <SingleColumnSection>
          <div className={classes.textSection}>
            ...
            <Typography variant="body2" className={classes.body}>
              Thanks for being part of the EA Forum and helping the community think about how to do the most good in the
              world.
            </Typography>
          </div>
        </SingleColumnSection>
