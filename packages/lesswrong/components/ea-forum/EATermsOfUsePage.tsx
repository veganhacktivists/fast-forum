...
const EATermsOfUsePage = ({classes}: {classes: ClassesType}) => {
  ...
  return (
    <div className={classes.root}>
      <Typography variant="display1" className={classes.title}>Effective Ventures Foundation - Terms of Use – FAST FORUM ADDENDUM</Typography>
      ...
      <Typography variant="body1">
        The Terms are entered into by you and EVF and in addition to this Addendum, it governs your access to and use of the FAST Forum. Please read the Terms and this Addendum carefully before you access or use the FAST Forum.
      </Typography>
      <Typography variant="body1">
        By accessing or using the FAST Forum, you confirm that you accept these Terms, this Addendum and all policies referenced in them and you agree to comply with them. If you do not agree to the Terms and/or this Addendum, and all other policies referred to in them, then you must not access or use any EVF Sites (as defined in the Terms).
      </Typography>
      <Typography variant="body1">
