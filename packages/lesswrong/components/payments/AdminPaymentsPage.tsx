...
export const AdminPaymentsPage = ({ classes }: { classes: ClassesType }) => {
  const { SingleColumnSection, SectionTitle, Loading, LoadMore, LWTooltip, UserTooltip, ErrorAccessDenied, ForumIcon } =
    Components;
