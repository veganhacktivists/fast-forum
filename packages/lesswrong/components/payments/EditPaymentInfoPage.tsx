...
export const EditPaymentInfoPage = ({ classes }: { classes: ClassesType }) => {
  ...
  return (
    <ContentStyles contentType="comment" className={classes.root}>
      ...
      <div className={classes.info}>
        <p>
          To be eligible for prizes and donations through LessWrong, you need a{" "}
          <a href="https://paypal.com/">PayPal account</a>, and to enter your associated PayPal email/info here.
        </p>
        <p>
          If you receive more than $600 in a year, you'll need to be entered into Center for Applied Rationality's
          payment system. CFAR will contact you via your LessWrong email address about next steps. (Make sure it's an
