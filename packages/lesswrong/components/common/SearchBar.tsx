...
const styles = (theme: ThemeType): JssStyles => ({
  ...
  searchInputAreaSmall: isFriendlyUI
    ...
    : {},
  searchIcon: {
    color: theme.palette.text.alwaysWhite, // isFriendlyUI ? undefined : theme.palette.header.text,
  },
...
const SearchBar = ({
  ...
  const closeSearch = () => {
    setSearchOpen(false);
    setInputOpen(false);
    if (onSetIsActive) onSetIsActive(false);
  };

  const handleSearchTap = () => {
    setInputOpen(true);
    setSearchOpen(!!currentQuery);
    if (onSetIsActive) onSetIsActive(true);
  };
      ...
      <div className={classes.rootChild}>
        ...
        >
          ...
          >
            ...
            {searchOpen && (
              <div className={classes.searchBarClose} onClick={closeSearch}>
                <CloseIcon className={classes.closeSearchIcon} />
              </div>
            )}
            <div>
              {searchOpen && (
                <Portal container={searchResultsArea.current}>
