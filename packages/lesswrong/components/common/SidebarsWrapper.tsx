...
const SidebarsWrapper = ({ children }: { children: React.ReactNode }) => {
  ...
  return <SidebarsContext.Provider value={sidebarsContext}>{children}</SidebarsContext.Provider>;
};
