...
const NavigationDrawer = ({
  ...
  return (
    ...
    >
      <div className={classNames(classes.drawerNavigationMenuUncompressed, { [classes.hideOnMobile]: showToc })}>
...
const NavigationDrawerComponent = registerComponent("NavigationDrawer", NavigationDrawer, { styles });
