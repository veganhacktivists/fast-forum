...
const NavigationStandalone = ({
  ...
  return (
    <>
      <Slide direction="right" in={!sidebarHidden} appear={false} mountOnEnter unmountOnExit>
        <div
        ...
        >
          ...
          <TabNavigationMenu transparentBackground={unspacedGridLayout} noTopMargin={noTopMargin} />
        </div>
      </Slide>
      {isLWorAF && (
...
const NavigationStandaloneComponent = registerComponent("NavigationStandalone", NavigationStandalone, { styles });
