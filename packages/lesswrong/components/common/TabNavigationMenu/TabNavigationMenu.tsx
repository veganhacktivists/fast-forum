    ...
    <AnalyticsContext pageSectionContext="navigationMenu">
      ...
      >
        {forumSelect(menuTabs).map((tab) => {
          ...
          return <TabNavigationItem key={tab.id} tab={tab} onClick={(e) => handleClick(e, tab.id)} />;
        })}
...
const TabNavigationMenuComponent = registerComponent("TabNavigationMenu", TabNavigationMenu, { styles });
