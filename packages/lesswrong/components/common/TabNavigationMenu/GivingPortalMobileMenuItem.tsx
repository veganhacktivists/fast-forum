...
const GivingPortalMobileMenuItem = ({ tab, onClick, classes }: TabNavigationItemProps) => {
  ...
  return <TabNavigationItem key={tab.id} tab={tab} onClick={onClick} className={classes.root} />;
};

const GivingPortalMobileMenuItemComponent = registerComponent(
  "GivingPortalMobileMenuItem",
  GivingPortalMobileMenuItem,
