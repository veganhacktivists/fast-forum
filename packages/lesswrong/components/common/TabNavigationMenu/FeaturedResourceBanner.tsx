...
const LinkButton = ({ resource, classes }: { classes: ClassesType; resource: FeaturedResourcesFragment }) => {
  ...
  return (
    <a href={resource.ctaUrl} target="_blank" rel="noopener noreferrer">
...
const FeaturedResourceBanner = ({ terms, classes }: { terms: FeaturedResourcesViewTerms; classes: ClassesType }) => {
  ...
  const hideBanner = () =>
    setCookie(HIDE_FEATURED_RESOURCE_COOKIE, "true", {
  ...
  return (
    <AnalyticsContext
      pageElementContext="featuredResourceLink"
      resourceName={resource.title}
      resourceUrl={resource.ctaUrl}
    >
...
const FeaturedResourceBannerComponent = registerComponent("FeaturedResourceBanner", FeaturedResourceBanner, { styles });
