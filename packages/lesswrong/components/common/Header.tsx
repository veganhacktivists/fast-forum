...
import { useIsDesktop } from "../hooks/useScreenWidth";

export const forumHeaderTitleSetting = new PublicInstanceSetting<string>(
  "forumSettings.headerTitle",
  "LESSWRONG",
  "warning",
);
export const forumShortTitleSetting = new PublicInstanceSetting<string>(
  "forumSettings.shortForumTitle",
  "LW",
  "warning",
);
...
const Header = ({
  ...
  const setSearchOpen = useCallback(
    (isOpen: boolean) => {
      if (isOpen) {
        captureEvent("searchToggle", { open: isOpen });
      }
    ...
    return (
      <React.Fragment>
        {toc?.sectionData?.sections ? (
          ...
          <IconButton
            className={classNames(classes.menuButton, { [classes.hideLgUp]: standaloneNavigationPresent && unFixed })}
            color="inherit"
            aria-label="Menu"
            onClick={() => setNavigationOpen(true)}
          >
        ...
        {standaloneNavigationPresent && unFixed && (
          <IconButton
            className={classNames(classes.menuButton, classes.hideMdDown)}
            color="inherit"
            aria-label="Menu"
  ...
  const usersMenuNode = currentUser && (
    <div className={searchOpen ? usersMenuClass : undefined}>
  ...
  const rightHeaderItemsNode = (
    <div className={classes.rightHeaderItems}>
      ...
      {currentUser && !currentUser.usernameUnset && (
        <KarmaChangeNotifier
  ...
  return (
    <AnalyticsContext pageSectionContext="header">
      <div className={classes.root}>
        ...
        >
          <header
            className={classNames(classes.appBar, { [classes.appBarDarkBackground]: !!backgroundColor })}
              ...
              <Link to="/" className={classes.titleLink}>
                <Typography className={classes.title} variant="title">
                  <div className={classes.titleSubtitleContainer}>
                    {hasProminentLogoSetting.get() ? (
                      <div className={classes.siteLogo}>
                        <div className={classes.hideSmUp}>
                          <SiteLogoSmall eaWhite={!!backgroundColor} />
                        </div>
                        <div className={classes.hideXsDown}>
                          <SiteLogo eaWhite={!!backgroundColor} />
                        </div>
                      </div>
                    ) : (
