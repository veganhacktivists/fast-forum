...
declare global {
  ...
  type JssStylesCallback<ClassKey extends string = string> = (theme: ThemeType) => JssStyles<ClassKey>;
  ...
  type WithMessagesMessage =
    | string
    | { id?: string; properties?: any; messageString?: string; type?: string; action?: any };
