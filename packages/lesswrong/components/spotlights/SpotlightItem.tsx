...
const styles = (theme: ThemeType): JssStyles => ({
  ...
  title: {
    ...
    fontSize: 20,
    ...(isFriendlyUI ? { fontWeight: 600 } : { fontVariant: "small-caps" }),
    lineHeight: "1.2em",
    display: "flex",
    alignItems: "center",
  },
        ...
        <div className={classes.spotlightItem}>
          <div className={classNames(classes.content, { [classes.postPadding]: spotlight.documentType === "Post" })}>
            ...
            {spotlight.showAuthor && spotlight.document.user && (
              <Typography variant="body2" className={classes.author}>
                by{" "}
                <Link className={classes.authorName} to={userGetProfileUrlFromSlug(spotlight.document.user.slug)}>
                  {spotlight.document.user.displayName}
                </Link>
              </Typography>
            )}
          ...
          <div className={classes.editAllButton}>
            {showAdminInfo && userCanDo(currentUser, "spotlights.edit.all") && (
              <LWTooltip title="Edit Spotlight">
                <MoreVertIcon
                  className={classNames(classes.editButtonIcon, classes.editAllButtonIcon)}
          ...
          <>
            {edit ? (
              ...
              <div className={classes.metaData}>
                ...
                <MetaInfo>
                  <FormatDate date={spotlight.lastPromotedAt} format="YYYY-MM-DD" />
                </MetaInfo>
