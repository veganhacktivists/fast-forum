...
const EventsHome = ({ classes }: { classes: ClassesType }) => {
  ...
  let loadMoreButton = showLoadMore && (
    <button className={classes.loadMore} onClick={() => loadMore(null)}>
      ...
      <div className={classes.section}>
        <div className={classes.sectionHeadingRow}>
          ...
          <div className={classes.sectionDescription}>
            Join people from around the world for discussions, talks, and other events on how we can tackle the world's
            biggest problems.
          </div>
        </div>
        ...
        <div className={classes.eventCards}>
          ...
          <div className={classes.filters}>
            ...
            >
              ...
              <MenuItem key="in-person" value="in-person">
                In-person only
              </MenuItem>
          ...
          <EventCards
            events={results || []}
            loading={loading || userLocation.loading}
            numDefaultCards={6}
            hideSpecialCards={!numSpecialCards}
          />

          <div className={classes.loadMoreRow}>{loadMoreButton}</div>
        </div>
      </div>
    </AnalyticsContext>
  );
