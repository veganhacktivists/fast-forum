...
const HighlightedEventCard = ({
      ...
      <Card className={classes.root} style={cardBackground}>
        ...
        <div className={classes.content}>
          <div className={classes.text}>
            ...
            <div className={classes.detail}>Conferences in various locations</div>
          </div>
        </div>
      </Card>
    );
  ...
  return (
    <Card className={classes.root} style={cardBackground}>
      ...
      <div className={classes.content}>
        <div className={classes.text}>
          <div className={classes.detail}>{prettyEventDateTimes(event, timezone, true)}</div>
          <h1 className={classes.title}>
            <Link to={`/events/${event._id}/${event.slug}`} onClick={() => captureEvent("highlightedEventClicked")}>
              {event.title}
            </Link>
          </h1>
          <div className={classes.detail}>{getEventLocation(event)}</div>
        </div>
      </div>
    </Card>
  );
