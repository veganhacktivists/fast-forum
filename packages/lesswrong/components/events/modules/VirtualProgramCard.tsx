...
const styles = createStyles(
  (theme: ThemeType): JssStyles => ({
    ...
    introVPCard: {
      background:
        "linear-gradient(rgba(0, 87, 102, 0.7), rgba(0, 87, 102, 0.7)), url('https://res.cloudinary.com/cea/image/upload/w_374,h_373,c_fill,q_auto,f_auto/Event/pz3xmsm63xl8thlyt2up.jpg')",
      padding: "50px 24px",
    ...
    inDepthSection: {
      background:
        "linear-gradient(rgba(0, 87, 102, 0.7), rgba(0, 87, 102, 0.7)), url('https://res.cloudinary.com/cea/image/upload/w_374,h_243,c_fill,q_auto,f_auto/Event/f2cbeqvjyhyl6rhhzdsu.jpg')",
      clipPath: "polygon(0 0, 100% 0, 100% 54%, 0 100%)",
      borderRadius: `${theme.borderRadius.default}px ${theme.borderRadius.default}px 0 0`,
    },
    precipiceSection: {
      background:
        "linear-gradient(rgb(168, 114, 51, 0.5), rgb(168, 114, 51, 0.5)), url('https://res.cloudinary.com/cea/image/upload/w_374,h_243,c_fill,q_auto,f_auto/Event/xfhrtorwdxxmplaofqa8.jpg')",
...
const VirtualProgramCard = ({ program, classes }: { program: string; classes: ClassesType }) => {
    ...
    return (
      ...
      >
        <Card className={classNames(classes.eventCard, classes.introVPCard)}>
          ...
          <div className={classes.eventCardTitle}>Introductory EA Program</div>
      ...
      <Card className={classes.eventCard}>
        ...
        >
          <div>
            ...
            <div className={classes.eventCardTitle}>In-Depth EA Program</div>
            <div className={classes.eventCardDescription}>
