...
const ImageUploadDefaultsDialog = ({
  onSelect,
  onClose,
  classes,
  type,
          ...
          {[...defaultImages[imageType]].map((img) => {
            return (
              <div
                ...
                tabIndex={0}
              >
                <CloudinaryImage2 publicId={img} width={240} height={125} imgProps={{ q: "100" }} />
              </div>
            );
          })}
        </div>
...
const ImageUploadDefaultsDialogComponent = registerComponent("ImageUploadDefaultsDialog", ImageUploadDefaultsDialog, {
  styles,
});
