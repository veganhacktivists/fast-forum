  ...
  return (
    <div className={classes.root}>
      <Components.ErrorBoundary>
        <Components.TagsSearchAutoComplete clickAction={setSelectedTagId} placeholder={label} />
      </Components.ErrorBoundary>
      {!loading && selectedTag?.name ? (
        <Chip onDelete={() => setSelectedTagId(undefined)} className={classes.chip} label={selectedTag?.name} />
      ) : (
        <></>
      )}
    </div>
