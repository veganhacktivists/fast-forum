...
const PostsPageQuestionContent = ({
  post,
  answersTree,
  refetch,
}: {
  ...
  return (
    <div>
      {(!currentUser || userIsAllowedToComment(currentUser, post, author, false)) && !post.draft && (
        <NewAnswerCommentQuestionForm post={post} refetch={refetch} />
      )}
