    ...
    <div className={classNames(classes.root, { [classes.hidden]: hidden })}>
      ...
      <div>
        <Tooltip
          title={
            <div>
              <div>By default, archived posts are hidden.</div>
        ...
        >
          ...
          >
            ...
            <MetaInfo className={classes.checkboxLabel}>{preferredHeadingCase("Show Archived")}</MetaInfo>
          </QueryLink>
        </Tooltip>
        <Tooltip
          title={
            <div>
              <div>By default, posts shared with you are shown.</div>
        ...
        >
          ...
          >
            <Checkbox
              classes={{ root: classes.checkbox, checked: classes.checkboxChecked }}
              checked={currentIncludeShared}
            />

            <MetaInfo className={classes.checkboxLabel}>{preferredHeadingCase("Show Shared with You")}</MetaInfo>
          </QueryLink>
        </Tooltip>
      </div>
    </div>
...
const DraftsListSettingsComponent = registerComponent("DraftsListSettings", DraftsListSettings, { styles });
