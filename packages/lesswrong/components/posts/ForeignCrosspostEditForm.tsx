...
const ForeignCrosspostEditForm = ({ post, classes }: { post: PostsPage; classes: ClassesType }) => {
  ...
  return (
    <SingleColumnSection>
      ...
      <Typography variant="body2" gutterBottom>
        ...
        to edit on {fmCrosspostSiteNameSetting.get()}.
      </Typography>
      {post.draft && (
        <Typography variant="body2">
          This crosspost is a draft. Crosspost drafts cannot be undrafted. You will need to{" "}
...
const ForeignCrosspostEditFormComponent = registerComponent("ForeignCrosspostEditForm", ForeignCrosspostEditForm, {
  styles,
});
