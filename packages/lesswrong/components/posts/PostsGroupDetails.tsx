...
const styles = (theme: ThemeType): JssStyles => ({
  ...
  notRecentDiscussionTitle: {
    fontFamily: isFriendlyUI ? theme.palette.fonts.sansSerifStack : theme.typography.body1.fontFamily,
  },
...
const PostsGroupDetails = ({
  ...
  return (
    <div className={inRecentDiscussion ? "" : classes.root}>
      <div
...
const PostsGroupDetailsComponent = registerComponent("PostsGroupDetails", PostsGroupDetails, { styles });
