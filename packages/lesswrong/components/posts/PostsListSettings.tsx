...
const FILTERS_ALL: ForumOptions<Partial<Record<Filters, SettingsOption>>> = {
  ...
  LessWrong: {
    ...
    frontpage: {
      label: "Frontpage",
      tooltip:
        "Moderators add posts to the frontpage if they meet certain criteria: aiming to explain, rather than persuade, and avoiding identity politics.",
    },
    curated: {
      label: "Curated",
...
const PostsListSettings = ({
  ...
  currentHideCommunity = false,
  timeframes = defaultTimeframes,
  sortings = SORT_ORDER_OPTIONS,
  showTimeframe,
  classes,
}: {
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <MetaInfo className={classes.checkboxLabel}>{preferredHeadingCase("Show Low Karma")}</MetaInfo>
          </QueryLink>
        </Tooltip>
        ...
        >
          ...
          >
            <Checkbox
              classes={{ root: classes.checkbox, checked: classes.checkboxChecked }}
              checked={currentIncludeEvents}
            />

            <MetaInfo className={classes.checkboxLabel}>{preferredHeadingCase("Show Events")}</MetaInfo>
          </QueryLink>
        </Tooltip>
      </div>
    </div>
...
const PostsListSettingsComponent = registerComponent("PostsListSettings", PostsListSettings, { styles });
