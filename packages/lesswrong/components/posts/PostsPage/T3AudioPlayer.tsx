...
export const T3AudioPlayer = ({
  ...
  return (
    <div ref={divRef} onMouseOver={() => setMouseOverDiv(true)} onMouseOut={() => setMouseOverDiv(false)}>
      <Helmet>
      ...
      <div className={classNames(classes.embeddedPlayer, { [classes.hideEmbeddedPlayer]: !showEmbeddedPlayer })}>
        {/* @ts-ignore */}
        <type-3-player analytics="custom"></type-3-player>
      </div>
    </div>
  );
};
