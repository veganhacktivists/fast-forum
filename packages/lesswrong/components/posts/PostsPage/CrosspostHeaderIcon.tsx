...
import { fmCrosspostSiteNameSetting, fmCrosspostBaseUrlSetting, isLW } from "../../../lib/instanceSettings";
...
const CrosspostHeaderIconComponent = registerComponent("CrosspostHeaderIcon", CrosspostHeaderIcon, { styles });
