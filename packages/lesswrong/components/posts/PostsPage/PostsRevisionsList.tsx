...
const PostsRevisionsList = ({ post, classes }: { post: PostsBase; classes: ClassesType }) => {
  ...
  return (
    <React.Fragment>
      ...
      <MenuItem onClick={(ev) => navigate(`/revisions/post/${post._id}/${post.slug}`)}>Compare Revisions</MenuItem>
    </React.Fragment>
  );
};

const PostsRevisionsListComponent = registerComponent("PostsRevisionsList", PostsRevisionsList, { styles });
