 ...
 */
export const PostMostValuableCheckbox = ({ post, classes }: { post: PostsBase; classes: ClassesType }) => {
  ...
  return (
    <Components.ForumIcon onClick={toggleChecked} icon={checked ? "Heart" : "HeartOutline"} className={classes.root} />
  );
};
