...
const styles = (theme: ThemeType): JssStyles => ({
  ...
  read: {
    color: isFriendlyUI ? theme.palette.primary.main : theme.palette.primary.light,
  },
  unread: {
...
export const PostReadCheckbox = ({
  ...
  if (isRead) {
    return (
      <LWTooltip title="Mark as unread">
        <CheckBoxTwoToneIcon
