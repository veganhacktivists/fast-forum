      ...
      {showShortformButton && (
        <Button
          ...
          onClick={async (e) => {
            ...
            const shortformContents = {
              originalContents: { type: "ckEditorMarkup", data: shortformString },
            } as DbComment["contents"];
        ...
        >
          {loading ? "Publishing to shortform ..." : `Publish to ${currentUser?.displayName}'s shortform`}
        </Button>
      )}
      <Button
        type="submit"
