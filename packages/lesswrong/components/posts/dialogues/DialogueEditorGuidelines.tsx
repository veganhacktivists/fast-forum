...
export const DialogueEditorGuidelines = ({ classes }: { classes: ClassesType<typeof styles> }) => {
  return (
...
const DialogueEditorGuidelinesComponent = registerComponent("DialogueEditorGuidelines", DialogueEditorGuidelines, {
  styles,
});
