...
describe("SelectQuery", () => {
  runTestCases([
    ...
    },
    {
      ...
      getQuery: () => new SelectQuery(testTable, { b: "test" }, { collation: { locale: "en", strength: 2 } }),
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE ( "a" IS NULL AND "b" IS NULL AND "c" IS NOT NULL )',
      expectedArgs: [],
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE ( "a" IS TRUE AND "b" IS TRUE AND "c" IS NOT TRUE )',
      expectedArgs: [],
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE ( "a" IS FALSE AND "b" IS FALSE AND "c" IS NOT FALSE )',
      expectedArgs: [],
    },
    {
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE "a" ::DOUBLE PRECISION IN ( $1 ::DOUBLE PRECISION , $2 ::DOUBLE PRECISION , $3 ::DOUBLE PRECISION )',
      expectedArgs: [1, 2, 3],
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE "a" ::DOUBLE PRECISION IN ( SELECT NULL::DOUBLE PRECISION )',
      expectedArgs: [],
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE "d" ::TEXT[] && ARRAY[ $1 ::TEXT , $2 ::TEXT ]',
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE NOT ( "a" ::DOUBLE PRECISION IN ( $1 ::DOUBLE PRECISION , $2 ::DOUBLE PRECISION , $3 ::DOUBLE PRECISION ) )',
      expectedArgs: [1, 2, 3],
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE "a" @> ARRAY[ $1 ::DOUBLE PRECISION , $2 ::DOUBLE PRECISION ]',
      expectedArgs: [10, 20],
    },
    {
    ...
    },
    {
      ...
      getQuery: () =>
        new SelectQuery<DbTestObject>(testTable, {
          a: {
            $near: {
              $geometry: {
                type: "Point",
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* FROM "TestCollection" WHERE "a" = $1 ORDER BY "b" DESC NULLS LAST LIMIT $2 OFFSET $3',
    ...
    },
    {
      ...
      expectedSql:
        'SELECT * FROM "TestCollection" , LATERAL (SELECT jsonb_agg("TestCollection2".*) AS "data2" FROM "TestCollection2" WHERE "TestCollection"."b" = "TestCollection2"."data") Q WHERE "a" = $1',
      expectedArgs: [3],
    },
    {
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* , (CASE WHEN "b" IS NOT NULL THEN "b" ELSE $1 END) AS "k" FROM "TestCollection" WHERE "a" = $2',
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* , (CASE WHEN "b" = $1 THEN $2 ELSE $3 END) ::INTEGER AS "k" FROM "TestCollection" WHERE "a" = $4',
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* , (CASE WHEN "a" IS NOT NULL THEN $1 ELSE $2 END) ::INTEGER AS "k" FROM "TestCollection" WHERE "a" = $3',
      expectedArgs: [2, 4, 3],
    },
    {
    ...
    },
    {
      ...
      expectedSql:
        'SELECT "TestCollection".* , (1000 * EXTRACT(EPOCH FROM $1 - "b" )) AS "k" FROM "TestCollection" WHERE "a" = $2',
    ...
    },
    {
      ...
      getQuery: () =>
        new SelectQuery<DbTestObject>(testTable, { a: 3 }, {}, { joinHook: 'JOIN "TestCollection2" on "b" = "c"' }),
