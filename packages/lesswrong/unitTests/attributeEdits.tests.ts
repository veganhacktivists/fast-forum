import {
  ...
  attributionsToSpans,
  spansToAttributions,
  applyAttributionsToText,
} from "../server/attributeEdits";
...
describe("Diff attribution tracking", () => {
  ...
  it("spansToAttributions", () => {
    chai.assert.deepEqual(
      spansToAttributions(
        '<div><span class="by_x">12</span><span class="by_y">34</span><span class="by_z">5</span><span class="by_w">6</span></div>',
      ),
      ["x", "x", "y", "y", "z", "w"],
    );
  });
  ...
  it("attributeEdits", () => {
    chai.assert.deepEqual(attributeEdits("<div>Asdf</div>", "<div>Asdf ghjk</div>", "2", [..._.times(4, () => "1")]), [
      ..._.times(4, () => "1"),
      ..._.times(5, () => "2"),
    ]);
    ...
    chai.assert.deepEqual(attributeEdits("<div>x y</div>", "<div>x  z</div>", "2", [..._.times(3, () => "1")]), [
      ..._.times(3, () => "1"),
      "2",
    ]);

    chai.assert.deepEqual(
      attributeEdits("<div><p>Lorem ipsum.</p></div>", "<div><p>Lorem ipsum.</p><p>Second paragraph.</p></div>", "3", [
        ..._.times(6, () => "1"),
        ..._.times(6, () => "2"),
      ]),
