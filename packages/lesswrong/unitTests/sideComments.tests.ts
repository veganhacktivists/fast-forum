...
import {
  ...
  commentToQuoteShards,
  annotateMatchedSpans,
  matchSideComments,
} from "../server/sideComments";
...
describe("side-comment blockquote matching", () => {
  ...
  it("finds exact-match blockquotes", () => {
    chai.assert.equal(
      getCommentQuotedBlockID(
        '<div><p id="firstParagraph">Lorem ipsum</p>' + '<p id="secondParagraph">dolor sit amet</p></div>',
  ...
  it("splits comments into quote shards", () => {
    ...
    chai.assert.deepEqual(
      commentToQuoteShardStrings(
        "<blockquote><p>Lorem ipsum dolor sit amet</p><p>adipiscing lorem amor asdf dolor sit amet</p></blockquote>",
      ),
      ...
      chai.assert.deepEqual(
        commentToQuoteShardStrings(
          "<blockquote>Lorem ipsum dolor sit amet" +
            ellipses +
            "adipiscing lorem amor asdf dolor sit amet</blockquote>",
        ),
        ["Lorem ipsum dolor sit amet", "adipiscing lorem amor asdf dolor sit amet"],
      );
    }
  ...
  it("handles HTML inside quote shards", () => {
    chai.assert.deepEqual(
      commentToQuoteShardStrings(
        "<blockquote><p>Lorem <i>ipsum</i> dolor sit amet</p><p>adipiscing lorem amor asdf dolor sit amet</p></blockquote>",
      ),
...
describe("annotateMatchedSpans", () => {
  it("works inside a single text node", () => {
    chai.assert.equal(
      annotateMatchedSpans("<p>Lorem ipsum <em>dolor</em> sit amet adipiscing</p>", [
  ...
  it("works with elements that have attributes", () => {
    chai.assert.equal(
      annotateMatchedSpans('<p id="block0">Lorem ipsum <em>dolor</em> sit amet adipiscing</p>', [
