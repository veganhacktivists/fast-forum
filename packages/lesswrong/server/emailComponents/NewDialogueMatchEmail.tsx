...
const NewDialogueMatchEmail = ({ documentId, targetUser }: { documentId: string; targetUser?: DbUser | null }) => {
  ...
  return (
    <React.Fragment>
      <p>
        There is a new dialogue match for you! Both you and <EmailUsername user={targetUser} /> have indicated that you
        would be potentially interested in having a dialogue.{" "}
      </p>
      <p>
        To see all matches, visit the <a href={`${getSiteUrl()}dialogueMatching`}>Dialogue Matching page</a>.
      </p>
    </React.Fragment>
  );
};
