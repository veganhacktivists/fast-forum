...
import { addAuthMiddlewares, expressSessionSecret } from "./authenticationMiddlewares";
...
export function startWebserver() {
  ...
  app.get("*", async (request, response) => {
    ...
    const externalStylesPreload = globalExternalStylesheets
    ...
    if (redirectUrl && !prefetchResources) {
      ...
      response.write(
        ...
        headers.join("\n") +
          ...
          "</head>\n" +
          '<body class="' +
          classesForAbTestGroups(allAbTestGroups) +
          '">\n' +
          ssrBody +
          "\n" +
          "</body>\n" +
