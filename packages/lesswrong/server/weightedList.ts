...
export class WeightedList {
  ...
  push(element: any) {
    ...
    if (Array.isArray(element)) {
      ...
      if (typeof key === "undefined") {
        ...
        throw new Error("In array passed to WeightedList.push([ ... ]), second " + "element is undefined!");
      }
      ...
      if (typeof key === "undefined") {
        ...
        // I suppose we could default to 1 here, but the API is already too forgiving
        throw new Error("In array passed to WeightedList.push({ ... }), no " + "{'weight': 42} pair found");
      }
    } else {
      // else what the heck were you trying to give me?
      throw new Error(
        'WeightedList.push() passed unknown type "' +
          typeof element +
  ...
  peek(n: number, andRemove?: boolean) {
    ...
    if (this.length - n < 0) {
      throw new Error(
        "Stack underflow! Tried to retrieve " +
          n +
          " element" +
          (n === 1 ? "" : "s") +
          " from a list of " +
