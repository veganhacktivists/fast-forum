...
getCollectionHooks("Posts").updateBefore.add(function onEditAddLinkSharingKey(
  data: Partial<DbPost>,
  { oldDocument },
): Partial<DbPost> {
...
defineQuery({
  ...
  fn: async (
    ...
    const keysMatch =
      ...
      constantTimeCompare({ correctValue: canonicalLinkSharingKey, unknownValue: linkSharingKey });
