...
const ckEditorEnvironmentIdOverrideSetting = new PublicInstanceSetting<string | null>(
  "ckEditorOverride.environmentId",
  null,
  "optional",
);
const ckEditorSecretKeyOverrideSetting = new PublicInstanceSetting<string | null>(
  "ckEditorOverride.secretKey",
  null,
  "optional",
);
const ckEditorApiPrefixOverrideSetting = new PublicInstanceSetting<string | null>(
  "ckEditorOverride.apiPrefix",
  null,
  "optional",
);
const ckEditorApiSecretKeyOverrideSetting = new PublicInstanceSetting<string | null>(
  "ckEditorOverride.apiSecretKey",
  null,
  "optional",
);

export const getCkEditorEnvironmentId = () =>
  ckEditorEnvironmentIdOverrideSetting.get() || ckEditorEnvironmentIdSetting.get();
...
export const getCkEditorApiSecretKey = () =>
  ckEditorApiSecretKeyOverrideSetting.get() || ckEditorApiSecretKeySetting.get();
