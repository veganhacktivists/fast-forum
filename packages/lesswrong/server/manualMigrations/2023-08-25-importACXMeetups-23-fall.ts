...
const acxData: ACXMeetup[] = [
  ...
  },
  {
    ...
    "Location description":
      "Bushbaby Lodge, there will be seating arranged and a sign in case there are other groups meeting that day too.",
  ...
  },
  {
    ...
    "Location description":
      "Looking to meet at Grease Monkey in Braddon. I will book a table under the name Andy, will probably be in the outside area.",
    "Plus.Code Coordinates": "https://plus.codes/4RPFP4GM+Q2X",
    Date: "10/2/2023",
    Time: "5:00:00 PM",
    Notes:
      "GreaseMonkey have half-price drinks and snacks from 4pm-6pm. I will look to organise a chip-in for pizzas for those that are keen :-)",
  ...
  },
  {
    ...
    Time: "2:00:00 PM",
    Notes:
      "I will have an ACX sign. Email me in case of bad weather/you can't find me/you can't make that time but would still like to meet etc.",
  ...
  },
  {
    ...
    Time: "3:00:00 PM",
    Notes:
      "We may need to change venues; the alternative location is 3rd Wave Art Studio, Room B, 2/F, Hollywood Building, 186 Hollywood Rd, Sheung Wan. I'll leave a comment on the LessWrong event if we change, and you can also email me to confirm.",
  ...
  },
  {
    ...
    City: "Mumbai, India",
    "Location description":
      "Versova Social, Mumbai. We have arranged to use the co-working space at Versova Social and will be on the 2nd floor. Link: goo.gl/maps/1RLjZwTB2bfaQVmN6 ",
    ...
    Notes:
      "Please RSVP on LessWrong or via email, so we can arrange for enough food and space. LW Link: https://www.lesswrong.com/events/Yj9MHguuKHaznp4bo/acx-meetups-everywhere-fall-2023-1. Google group link: https://groups.google.com/g/acx-mumbai/about",
  ...
  },
  {
    ...
    "Location description":
      "We'll meet at Kings Hall Cafe (https://goo.gl/maps/cWNjqdaHUeLphGNd9). We'll have a make-shift ACX sign on the table, so you might have to walk around and look closely.",
  ...
  },
  {
    ...
    Time: "2:30:00 PM",
    Notes:
      "Likely a small group so open to change if we want to co-ordinate that. Please RSVP so I'm not waiting for no-one :)",
  ...
  },
  {
    ...
    Time: "5:30:00 PM",
    Notes:
      "This meetup will be run in collaboration with Effective Altruism Wellington.  The external door closes at 6pm, but if you call me I can let you in. reach me on 0+2+7+3+4+4+1+0+8+2",
  ...
  },
  {
    ...
    Time: "6:00:00 PM",
    Notes:
      "Gelmeyi düşünenler önden mail atarsa sevinirim, hiç mail gelmezse uzun süre boş boş beklemeyeyim. - I'd appreciate it if prospective attendees send an email beforehand so I won't have to wait for no one to appear.",
  ...
  },
  {
    ...
    "Location description":
      "We will be meeting at Fixed Point, Koperníkova 6, 120 00 Vinohrady, Prague, there will be signs to lead you to the main location.",
    "Plus.Code Coordinates": "https://plus.codes/9F2P3CCR+3C",
    Date: "10/3/2023",
    Time: "6:30:00 PM",
    "Event Link": "https://www.facebook.com/events/1326413691300378",
    Notes:
      "Please RSVP on Facebook https://fb.me/e/1bQg1Bitu so we know how much food to get (if we manage to get it) and can design the space and the program appropriately. Kids are welcome, but we won't have any special program for them. No dogs please.",
  ...
  },
  {
    ...
    "Location description":
      "Kitty's Public House, Mannerheimintie 5. We'll be in the private room called Kitty's Lounge, find it and come in.",
  ...
  },
  {
    ...
    "Location description":
      "We'll meet at the Parc Montsouris, just below Cité Universitaire. We'll be in front of the Avenue Reille and Avenue René Corty entrance, behind the statue on the grass. We'll have an ACX meetup sign and tableclothes",
  ...
  },
  {
    ...
    Time: "3:00:00 PM",
    Notes:
      "Please RSVP on LessWrong so I know that someone is indeed coming. This will be a small meetup with no fixed topic, so whatever you want to discuss, we can discuss it!",
  ...
  },
  {
    ...
    "Location description":
      "Pub The Tower of London, 39 Gd Rue Saint-Michel, 31400 Toulouse. We'll have a sign saying ACX Meetup, and we'll probably be sitting in the back.",
  ...
  },
  {
    ...
    City: "Bremen, Germany",
    "Location description":
      "Fehrfeld (the bar, not the street); there will be an Epic Perplexus Ball on or at our table.",
    "Plus.Code Coordinates": "https://plus.codes/9F5C3RFF+9Q",
    Date: "9/26/2023",
    Time: "7:00:00 PM",
    Notes:
      "At the spring meetup, we decided to kick off a regular event. Since then, our group has grown from two to four people! We now gather on the fourth Tuesday evening of every month, so if you can't make it for the September meetup, we will also meet on October 24th, same place and time. Of course, you are also cordially invited if you don't want to commit to attend the meetup regularly. And if you can't make it, do not hesitate to reach out to me.",
  ...
  },
  {
    ...
    Time: "8:00:00 PM",
    Notes:
      "Depending on how many people sign up we might need to find a different spot. Let me know if you are interested in coming, so I can estimate!",
  ...
  },
  {
    ...
    City: "Munich, Germany",
    "Location description":
      "Sandstraße 25, there will be a sign in front of the door, if the weather is good we'll meet it in the inner yard, if it's bad we'll meet in my apartment on the 2nd floor",
    "Plus.Code Coordinates": "https://plus.codes/8FWH4HX4+JF",
    Date: "9/5/2023",
    Time: "7:00:00 PM",
    Notes:
      "I'll have some drinks, but it would be great if you could also bring some. At around 20:00 we'll order Pizzas.",
  ...
  },
  {
    ...
    "Location description":
      "Northeast corner of the Museum Kért, near Kálvin. I'll bring a big purple book by Richard Dawkins, and someone might set up a sign.. If it rains we'll move to Lumen, a nearby cafe.",
  ...
  },
  {
    ...
    City: "Pisa, Italy",
    "Location description":
      "Orzo Bruno, Via delle Case Dipinte 6, I will be wearing a light blue shirt with VOLUNTEER written on it.",
  ...
  },
  {
    ...
    "Location description":
      "Vinco Kudirkos square (Vinco Kudirkos aikštė). I will be in front of the central statue with an ACX MEETUP sign.",
    "Plus.Code Coordinates": "https://plus.codes/9G67M7QJ+26",
    Date: "9/16/2023",
    Time: "3:00:00 PM",
    Notes:
      "RSVP via LessWrong or email (acx.vilnius@gmail.com) preferred, but not required. Don't have any big plans, anyone who wants to join is welcome.",
  ...
  },
  {
    ...
    "Location description":
      "We meet on top of a small hill East of the Linha d'Água café in Jardim Amália Rodrigues. I'll be wearing a pink t-shirt and we'll have a ACX MEETUP sign.",
    "Plus.Code Coordinates": "https://plus.codes/8CCGPRJW+V8",
    Date: "9/16/2023",
    Time: "3:00:00 PM",
    Notes:
      "For comfort, bring sunglasses and a blanket to sit on. There is some natural shade. Also, it can get quite windy, so bring a jacket.",
  ...
  },
  {
    ...
    "Location description":
      "Москва, Русаковская ул. д.31 - торговый центр Сокольники, 2 этаж, фуд-корт/Moscow, Russakovskaya st. 31 - Сокольники trade center, food-court. I will bring an SSC sign.",
  ...
  },
  {
    ...
    Time: "3:00:00 PM",
    Notes:
      "Please RSVP by email to Tatiana on the email above! The meet-up is the monthly meet-up of EA/LW/ACX crowd, usually we discuss some two topics. For example in August we are doing Life Extension and Healthy Relationships.",
  ...
  },
  {
    ...
    City: "Madrid, Spain",
    "Location description":
      "El Retiro Park, puppet theatre ( https://www.esmadrid.com/en/tourist-information/teatro-de-titeres-de-el-retiro )",
  ...
  },
  {
    ...
    "Location description":
      "Alpine Botanical Garden of Meyrin, round chair thingy in northern part, I'll be in a tie-dyed shirt ",
  ...
  },
  {
    ...
    "Location description":
      "Blatterwiese in front of the chinese garden. If it rains we will be inside the chinese garden under the roof (free entry).",
  ...
  },
  {
    ...
    City: "Liverpool, UK",
    "Location description":
      "The Merchant, 40 Slater St, Liverpool L1 4BX. I am a tall man with long hair and a handlebar moustache, I will be wearing a black shirt with the word YES printed on it in gold.",
  ...
  },
  {
    ...
    "Location description":
      "Newcastle Central Station portico. I'll be wearing a Hawaiian shirt and suit jacket and holding the Astral Codex Ten sign.",
  ...
  },
  {
    ...
    City: "Sheffield, UK",
    "Location description":
      "200 Degrees, 25 Division St, S1 4GE. I'll have a piece of paper on the table with ACX written on it.",
    "Plus.Code Coordinates": "https://plus.codes/9C5W9GJG+2M",
    Date: "9/16/2023",
    Time: "3:00:00 PM",
    Notes:
      "I'll be there from 3pm to at least 5pm, and maybe later if other people want to hang out for longer. So feel free to come join at any point.",
  ...
  },
  {
    ...
    "Location description":
      "Underground Tap & Grill, 10004 Jasper Ave, Edmonton, AB T5J 1R3. We will have an ACX sign - it usually isn't too busy, so we should be easy to find.",
  ...
  },
  {
    ...
    "Location description":
      "Meeting Room A, Kitchener Public Library Main Branch, 85 Queen St N, Kitchener, ON N2H 2H1",
  ...
  },
  {
    ...
    Notes:
      "Please RSVP on LessWrong: https://www.lesswrong.com/events/ngpZH9gA76CyHhrER/acx-meetups-everywhere-fall-2023-montreal-qc",
  ...
  },
  {
    ...
    Time: "7:00:00 PM",
    Notes:
      "Please RSVP by any of discord, email, facebook, or lesswrong! The meetup is indoors- kids welcome, but no pets, sorry. We'll be providing food at the meetup.",
  ...
  },
  {
    ...
    Time: "12:00:00 PM",
    Notes:
      "Only happens if someone actually confirms they're coming; hopefully it'll be possible to confirm at a later date if this is happening via LessWrong event or something.",
  ...
  },
  {
    ...
    "Location description":
      "Cafebrería El Péndulo, Av Nuevo León 115, Hipódromo, Cuauhtémoc, 06100 Ciudad de México, CDMX",
  ...
  },
  {
    ...
    "Location description":
      "The Writer's Block Bookstore & Cafe, 3956 Spenard Rd, Anchorage, AK 99517. I'll be wearing a green pullover and have a small sign on the table saying ACX MEETUP",
  ...
  },
  {
    ...
    "Location description":
      "Friends Meeting House, 1420 Hill St., Ann Arbor, MI 48104 , in the back yard. I'll be wearing black and have a white sign that says ACX. ",
  ...
  },
  {
    ...
    "Location description":
      "Lake Julian Park. We'll try to grab a picnic table near the playground but rsvp for precise update if you don’t want to hunt for the sign.",
  ...
  },
  {
    ...
    "Location description":
      "1737 Ellsworth Industrial Blvd NW, Atlanta, GA 30318, USA. We will be in the breezeway in the front.",
  ...
  },
  {
    ...
    "Location description":
      "Free Range Brewing - 2320 N. Davidson St., Charlotte, NC. I'll be in the outdoor seating section that is in front of the residential apartment buildings and will have an ACX MEETUP sign with me.",
  ...
  },
  {
    ...
    "Location description":
      "12 Rotunda Drive Charlottesville, VA 22903 - We’ll meet at the picnic tables across the street from The Virginian. There will be an ACX sign.",
  ...
  },
  {
    ...
    Time: "2:00:00 PM",
    Notes:
      "I've hosted various meetings of other kinds here, so I imagine it'll be fine. I'll call first to confirm. If they tell me no for some reason, I'll put it somewhere else in Cincinnati. There are plenty of good places.",
  ...
  },
  {
    ...
    "Location description":
      "Steps in front of McKeldin library, UMD campus. Visitor parking by Skinner Building. In case of rain, front of Skinner Building. ",
  ...
  },
  {
    ...
    "Location description":
      "On the outside porch at Torchy’s at 1037 Texas Ave South. I will have a sign that says ACX meetup.",
    "Plus.Code Coordinates": "https://plus.codes/8625JMFC+5J9",
    Date: "10/21/2023",
    Time: "7:00:00 PM",
    Notes:
      "Please RSVP on LessWrong so that I know how many people are coming or shoot me an email! Students and adults welcome.",
  ...
  },
  {
    ...
    "Location description":
      "We will be in the Whole Foods' upstairs seating area in the room closest to the windows/parking lot.",
  ...
  },
  {
    ...
    "Location description":
      "John Natsoulas Gallery, 521 1st St, Davis, CA 95616. We'll meet on the roof of the gallery, which is accessible by stairs and elevator. The space isn't very large, so there shouldn't be much opportunity for confusion, and I plan to greet everyone as they enter!",
    "Plus.Code Coordinates": "https://plus.codes/84CWG7R5+VJ",
    Date: "10/7/2023",
    Time: "1:00:00 PM",
    Notes:
      "Please feel free to bring anyone who may be interested in meeting new people, chatting, and playing social deduction board games like Avalon, Secret Hitler, Coup, etc. Dogs likely aren't allowed into the gallery, but children are absolutely fine!",
  ...
  },
  {
    ...
    "Location description":
      "Sloan's Lake, near the North Bicycle Parking Lot. We'll be a little past the old stone building, at a picnic table, with a blue shade-structure set up over it. It will have a white large board leaning against it with ACX MEETUP written on it.",
  ...
  },
  {
    ...
    "Location description":
      "Bucklin Park, El Centro, California. I'll be at the pond by the playground with a sign with ACX on it.",
  ...
  },
  {
    ...
    Time: "5:00:00 PM",
    Notes:
      "Hosted by the local ACX group that does meetups throughout south Florida, including Palm Beach, Broward, and Miami-Dade counties. Come join our Discord!",
  ...
  },
  {
    ...
    "Location description":
      "Millworks - 340 Verbeke St, Harrisburg, PA 17102. We'll plan to be on the rooftop biergarten if the weather is suitable, or inside downstairs otherwise. Look for the ACX Meetup sign on the table.",
  ...
  },
  {
    ...
    "Location description":
      "300 The Bridge St, Huntsville, AL 35806. We will be in the cafe with a whiteboard that says ACX Meetup",
  ...
  },
  {
    ...
    "Location description":
      "325 Carr Street, Jackson Mi 49201. The house is green with a fire hydrant in the front yard. The driveway is shared with my neighbor so please park on the street.",
    "Plus.Code Coordinates": "https://plus.codes/86JQ7H2H+96",
    Date: "9/23/2023",
    Time: "3:00:00 PM",
    Notes:
      "Please rsvp by email. I organize the Ann Arbor meetups but I live in Jackson, looking to see if there's anyone interested in a Jackson meetup as well! I'll have some snacks and drinks. Unless the weather is bad we'll hang out in the back yard and have a small fire. Bring your favorite camping chair.",
  ...
  },
  {
    ...
    "Location description":
      "Minsky's Pizza: 427 Main St, Kansas City, MO 64105 (we will be in the upstairs conference room, tell the hostess you are here for the conference room meeting)",
  ...
  },
  {
    ...
    Time: "2:00:00 PM",
    Notes:
      "No need to drink, even though it's a brewery, it just has good ambiance. Please RSVP on Meetup.com, because then the app will ding me and I'll know someone is coming. Search for Rationality La Crosse.",
  ...
  },
  {
    ...
    Time: "6:30:00 PM",
    Notes:
      "Please RSVP on LessWrong (not mandatory however): https://www.lesswrong.com/events/PqKq5qKLt5Rvvo5Yg/los-angeles-ca-acx-autumn-meetups-everywhere-2023-lw-acx. Direct questions to Vishal on the LAR discord. Invite here: https://discord.gg/TaYjsvN",
  ...
  },
  {
    ...
    "Location description":
      "French Truck Coffee, Crosstown Concourse, Central Atrium, 1350 Concourse Ave #167, Memphis, TN 38104. We'll be at a table in front of French Truck Coffee with an ACX MEETUP sign on it.",
  ...
  },
  {
    ...
    Time: "11:11:00 AM",
    Notes:
      "Text/Signal/WhatsApp me (Blake) at +1 504 377 3650 or email 1111@philosophers.group ... Happy to answer any questions.",
  ...
  },
  {
    ...
    "Location description":
      "We usually start in the front patio of my yard at 1970 port Laurent and weather permitting go for a walk in the park and the surround wild areas.",
  ...
  },
  {
    ...
    Notes:
      "If I run this it'll be totally open-ended (I'm planning ~12pm to ~2pm, but can totally go to any time). Also open beyond the rat community proper (I'll welcome postrats, alignment researchers, predictors, effective altruists, and rationalists).",
  ...
  },
  {
    ...
    "Location description":
      "Fair Grounds (cafe), we'll aim to be at the big round table to the right of the  ordering counter. Address: 806 Baldwin Ave # 2, Norfolk, VA 23517",
  ...
  },
  {
    ...
    "Location description":
      "Packard's (we have the Library Room in the back reserved), 14 Masonic St., Northampton, MA 01060",
    "Plus.Code Coordinates": "https://plus.codes/87J98998+7M",
    Date: "9/2/2023",
    Time: "6:00:00 PM",
    "Event Link":
      "https://www.lesswrong.com/events/Zxd2Sa4HaeESZWHXD/northampton-ma-acx-meetup-meetups-everywhere-fall-2023",
    Notes:
      "We're meeting in the Library Room in the way back of Packard's (we have it reserved). This has been one of our go-to meeting spots in the past and it works pretty well.",
  ...
  },
  {
    ...
    "Location description":
      "Meeting at the picnic tables near the playground, I'll put up an ACX MEETUP sign and be wearing a funny hat you can't miss. ",
  ...
  },
  {
    ...
    "Location description":
      "DEFAULT OUTDOOR MEETING LOCATION: Mellon Park (the portion SOUTH of Fifth Ave, and WEST of Beechwood Blvd). Look for us at the Rose Garden picnic tables, or the benches just outside the Rose Garden.",
    "Plus.Code Coordinates": "https://plus.codes/87G2F32J+QX",
    Date: "9/16/2023",
    Time: "2:00:00 PM",
    Notes:
      "INDOOR CONTINGENCY OPTION: In the event of rain, we will instead meet at City Kitchen at Bakery Square, which is a short walk from Melon Park. (City Kitchen has two levels, so be sure to check upstairs if you can't find us.) If we shift meeting locations, Justin will send an email update >2 hours before the scheduled meetup time, as well as a follow-up email with the table number once we have arrived and claimed a space; please contact pghacx@gmail.com if you would like to be added to the email list in advance.",
  ...
  },
  {
    ...
    "Location description":
      "Palmer square, by the picnic tables near the large pine tree. I'll have an ACX MEETUP sign.",
  ...
  },
  {
    ...
    "Location description":
      "The giant wooden bench overlooking the city right outside Cafe Josephine, by the Randall Museum in Corona Heights Park. We'll bring an ACX sign.",
    "Plus.Code Coordinates": "https://plus.codes/849VQH76+PWW",
    Date: "9/16/2023",
    Time: "10:00:00 AM",
    Notes:
      "Kids and dogs are very welcome. Great bathrooms, café, and children's museum on premises. Also tree shade and stunning view of the city.",
  ...
  },
  {
    ...
    "Location description":
      "Volunteer Park amphitheater! I'll have a table and a couple of signs saying Astral Codex Ten Meetup.",
  ...
  },
  {
    ...
    "Location description":
      "Pavilion at McKennan Park, or near it if it's occupied. I will have a laptop with a sign saying ACX MEETUP.",
  ...
  },
  {
    ...
    "Location description":
      "Stone Lake Lions' Hall. Come to the main door which has the accessible ramp. ACX Meetup will be in the cafe portion, which you can see from the main door.",
    "Plus.Code Coordinates": "https://plus.codes/86QCRFW6+5J6",
    Date: "9/9/2023",
    Time: "5:00:00 PM",
    Notes:
      "A regularly scheduled 2nd Saturday Barn Dance will be held in the dance hall portion of the building, at 7. You're welcome to stay, or welcome to leave after the ACX meetup.",
  ...
  },
  {
    ...
    "Location description":
      "Washington Park (840 W Washington Ave, Sunnyvale, CA 94086, USA). We will be on the roundish grassy area in the northeast corner of the park. Look for the folding table with attached ACX Meetup sign",
  ...
  },
  {
    ...
    "Location description":
      "Boxyard at 238 N 4th Ave. Look for ACX tabletop sign. I'll try to get the big shaded table way in the back (next to Los Perches).",
    "Plus.Code Coordinates": "https://plus.codes/854F62FM+VWW",
    Date: "10/7/2023",
    Time: "11:15:00 AM",
    Notes:
      "Boxyard is outdoor seating. It's likely that we'll have shade, but not a guarantee, so dress for possible sun.",
  ...
  },
  {
    ...
    "Location description":
      "Strange Brew Coffeehouse: 1101 University Blvd, Tuscaloosa, AL 35401. I'll be inside with a blue shirt and a laptop.",
  ...
  },
  {
    ...
    Time: "3:00:00 PM",
    Notes:
      "RSVPs are appreciated but not at all required. You can RSVP on LW or by email or by pinging me in the Discord server. Suggested entrance is the East side of the building - we'll try to make sure at least that door is unlocked, but if it isn't then ping us on email or Discord.",
  ...
  },
  {
    ...
    Time: "6:00:00 PM",
    Notes:
      "We've rented out the Froggy Bottom Pub for the night, dinner and soft drinks will be provided. Alcohol available for purchase if desired, but no purchases are required. There is metered street parking on nearby blocks; the closest Metro stations are Farragut West and Farragut North.",
  ...
  },
  {
    ...
    "Location description":
      "We'll be in the south of the Earhart Hall lobby (not the dining court) near the piano, and I will be wearing a shirt with a lemur and carrying a sign with ACX MEETUP on it.",
  ...
  },
  {
    ...
    "Location description":
      "Praça Nelson Mandela, right at the Botafogo subway station. It is possible that, once everyone is there, we'll go to a nearby Starbucks, just one street-crossing from the initial location.",
