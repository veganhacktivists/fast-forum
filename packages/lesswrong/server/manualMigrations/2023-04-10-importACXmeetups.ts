...
registerMigration({
  ...
  action: async () => {
    ...
    for (const row of acxData) {
      ...
      const localtime = eventTimePretendingItsUTC.getTime()
        ? await getLocalTime(eventTimePretendingItsUTC, googleLocation)
        : new Date();
      const actualTime = new Date(
        eventTimePretendingItsUTC.getTime() +
          (eventTimePretendingItsUTC.getTime() - (localtime?.getTime() || eventTimePretendingItsUTC.getTime())),
      );
      ...
      if (!existingPost && !premadePostObject) {
        ...
        if (existingPost) {
          ...
          eventCacheContents.push({
            _id: existingPost._id,
            lat: googleLocationInfo?.lat,
            lng: googleLocationInfo?.lng,
          });
...
const acxData: ACXMeetup[] = [
  {
    ...
    "Location description":
      "Lekki Leisure, Lagos. We will be overlooking the beach, sitting on the table to your left.",
  ...
  },
  {
    ...
    Time: "4:00:00 PM",
    "Event Link":
      "https://www.lesswrong.com/events/mkgmobxKDwntMNneL/bengaluru-lw-acx-social-meetups-meetups-everywhere-spring",
  ...
  },
  {
    ...
    Notes:
      "The park doesn't have a clear sign saying 'heritage gardens' but is opposite Glen Heights and can be found easily using maps (https://goo.gl/maps/ZondD21UeDJshSnV9).",
  ...
  },
  {
    ...
    Time: "3:00:00 PM",
    Notes:
      "Organized by EA Serbia, welcoming everyone including non ACX people if you'd like. Bring coloured eggs for Serbian Egg battles as it'll be easter, or we can provide some :) RSVP mandatory!",
  ...
  },
  {
    ...
    "Location description":
      "Place Victoire, south of the column/the Turtles. I wear a mask in places with a lot of strangers, and I will be holding a foldable-keyboard handheld. I will also write an A4 ACX Meetup sign. https://www.openstreetmap.org/?query=44.83054%2C-0.57268#map=19/44.83057/-0.57262",
    "Plus.Code Coordinates": "https://plus.codes/8CPXRCJG+7XG",
    Date: "04/22/2023",
    Time: "5:00:00 PM",
    "Event Link":
      "https://www.lesswrong.com/events/muYXAfbsJj4RCkEYY/ssc-acx-meetups-everywhere-spring-bordeaux-22-april-17-00",
  ...
  },
  {
    ...
    "Location description":
      "Dubliner, Mannerheimintie 5, Helsinki. We'll be in the private room named Guinness Lounge, find it and come in.",
  ...
  },
  {
    ...
    "Location description":
      "We meet on the KIT campus on the grass in front of Audimax, next to the large sculpture with the intertwined tubes",
    "Plus.Code Coordinates": "https://plus.codes/8FXC2C68+X5",
    Date: "04/22/2023",
    Time: "3:00:00 PM",
    Notes:
      "An event post will be created on the Karlsruhe Rationality Group on LessWrong; see there for more recent updates (e.g. in case of rain).",
  ...
  },
  {
    ...
    "Location description":
      "In Jardim Amália Rodrigues, close to Linha d'Água cafe, in the top of a hill, below a bunch of trees.",
  ...
  },
  {
    ...
    Time: "10:00:00 AM",
    Notes:
      "Please register via Eventbrite: https://www.eventbrite.co.uk/e/astral-codex-ten-meetup-tickets-591452770157",
  ...
  },
  {
    ...
    "Location description":
      "Mercado de San Ildefonso. Calle de Fuencarral, 57, 28004 Madrid. We'll be at the first or second floor, with an ACX sign",
  ...
  },
  {
    ...
    "Location description":
      "We'll be at Caroussel Garden (near the Louvres and Tuileries, left of the Arch from the Louvres), on the grass near the statues. We'll have an ACX MEETUP sign.",
    ...
    Notes:
      "We also have a discord ( https://discord.gg/2U9qhR2suc ) or matrix bridge ( https://matrix.to/#/#ssc-paris:matrix.org )",
  ...
  },
  {
    ...
    "Location description":
      "caféLaMorena. Rúa de San Clemente, 6, 15705 Santiago de Compostela, A Coruña. https://maps.app.goo.gl/FJ9vPnNTXcsvPx4LA. I'll be wearing an EAGx LatAm hoodie and maybe put up an ACX sign or something. Will sit outside, weather permitting, and inside otherwise.",
  ...
  },
  {
    ...
    Time: "4:00:00 PM",
    "Event Link":
      "https://www.lesswrong.com/events/4R5BHXhBW7puyXTvg/sofia-acx-spring-2023-schelling-meetup-mini-meetups",
  ...
  },
  {
    ...
    "Location description":
      "St Vitus, Tallinn.  I am the guy with a suit, a beard, and a book.  I shall attempt to make a sign if I get there early enough.",
  ...
  },
  {
    ...
    "Location description":
      "Le Biergarten, 60 Gd Rue St Michel, 31400, Toulouse. If the weather permits, we'll be sitting outside with a sign saying ACX MEETUP on the table",
  ...
  },
  {
    ...
    "Location description":
      "Bold Monk Brewing. 1737 Ellsworth Industrial Blvd NW. Suite D-1. Atlanta, GA 30318, USA. Look for the Yellow ACX Table Sign",
  ...
  },
  {
    ...
    "Location description":
      "UMBC outside of the Performing Arts and Humanities Building, on the north side. I will have a sign that says ACX meetup. Parking is free on the weekends. If it’s raining, we will be inside of the Performing Arts building, on the ground floor just inside the entrance.",
    "Plus.Code Coordinates": "https://plus.codes/87F5774P+53",
    Date: "04/23/2023",
    Time: "7:00:00 PM",
    Notes:
      "We are an active group that meets every Sunday at 7 PM. Half are virtual and half are in person. There will be snacks and drinks. ",
  ...
  },
  {
    ...
    "Location description":
      'Battery Park, in the southern section of the park, near the William Wells statue. I will have an "ACX Meetup" sign.',
  ...
  },
  {
    ...
    Notes:
      "We will be hosting lightning talks from Chicago Rationality meetup attendees for the May meetup. Join our Discord for more info: https://discord.gg/eDHq3TXrH3",
  ...
  },
  {
    ...
    "Location description":
      "Clifton Park Shelterhouse, Jeffrey Park, Bexley. We will be at one of the tables with an ACX sign.",
  ...
  },
  {
    ...
    "Location description":
      "Whole Foods, 11700 Preston Rd Ste 714, Dallas, TX 75230. We’ll be upstairs in the back room near the windows.",
  ...
  },
  {
    ...
    "Location description":
      "The location for our monthly meetups is the clubhouse in Eneasz's neighborhood. It's called Silver Valley. The Club House is just west of the address here: 8769 W Cornell Ave, Lakewood, CO 80227-4813. There's a pool and tennis court right by it, and lots of visitor parking all around.",
    "Plus.Code Coordinates": "https://plus.codes/85FPMW64+MW",
    Date: "04/23/2023",
    Time: "3:00:00 PM",
    Notes:
      "The meetup is open format, and will last until 9pm. Come at your convenience and stay as long or short as you like. They'll be a few silly games, and some snacks and drinks, including alcohol.",
  ...
  },
  {
    ...
    "Location description":
      "Underground Tap &amp; Grill. 10004 Jasper Ave, Edmonton, AB T5J 1R3. We will have an ACX sign",
  ...
  },
  {
    ...
    Notes:
      "Hosted by the local ACX group that does meetups throughout south Florida, including Palm Beach, Broward, and Miami-Dade counties. Come join our Discord! https://discord.gg/tDf8fYPRRP",
  ...
  },
  {
    ...
    "Location description":
      "Weather permitting: Condon Park near the prospector statue. Email me so that in case of rain I can let you know where my apartment is.",
  ...
  },
  {
    ...
    "Location description":
      "711 Milby St, Houston, TX 77023. Segundo Coffee Lab, inside the IRONWORKS through the big orange door, look for the ACX MEETUP sign at the entrance",
  ...
  },
  {
    ...
    Time: "6:30:00 PM",
    "Event Link":
      "https://www.lesswrong.com/events/WvXnkMCpd34NgYDkJ/los-angeles-ca-acx-spring-meetups-everywhere-2023-lw-acx",
    Notes:
      'Questions should be posted in the LAR discord (https://discord.gg/TaYjsvN), or by contacting "Vishal" in DMs via discord.',
  ...
  },
  {
    ...
    "Location description":
      "French Truck Coffee, Crosstown Concourse, Central Atrium. 1350 Concourse Ave, Memphis, TN 38104 We'll be at a table with a sign that says ACX MEETUP on it.",
  ...
  },
  {
    ...
    "Location description":
      "140 NE 39th St #001. Miami, FL 33137. Buckminster Fuller Fly's Eye Dome. Look for a paper sign that says ACX MEETUP west of the dome.",
    ...
    Notes:
      "Miami ACX started in 2017 and hosts events on a regular basis in Miami and Fort Lauderdale. Visit the LessWrong event link for more details including links to our Facebook, Meetup, and Discord.",
  ...
  },
  {
    ...
    "Location description":
      "Pagoda &amp; Oriental Garden, 265 W Tazewell St, Norfolk, VA 23510. We'll aim to sit or stand (recommendation: bring a folding chair) at the side of the Pagoda facing Freemason Harbor. I will wear a green shirt, green &amp; yellow hat, and have an ACX MEETUP sign. ",
    "Plus.Code Coordinates": "https://plus.codes/8785RPX4+W36",
    Date: "04/30/2023",
    Time: "10:30:00 AM",
    Notes:
      "We may decamp by 12:45 to wander around downtown and/or get lunch. Possible after-meetup hangout! If you can't make it to the meetup but can do lunch or something a little later, please email me. In Norfolk on a Wednesday in the future? We regularly meet Wednesday evenings at Fair Grounds (cafe in Ghent) from 17:00-19:30. There's are meetups in Richmond or occasionally in Charlotesville. Check out Virginia Rationalists on LessWrong for Upcoming Events: https://www.lesswrong.com/groups/pLEbtx3BbdaLMXZKi",
  ...
  },
  {
    ...
    Time: "6:00:00 PM",
    Notes:
      "This is the Meetups Everywhere Spring 2023 edition of a meetup that started in the 2018 Meetups Everywhere. At most meetups we get about 5-7 people out of a rotation of 15-20; Meetups Everywhere events tend to get a boost and we get closer to 8-10. Looking forward to a fun time!",
  ...
  },
  {
    ...
    City: "Ottawa, Canada ",
    "Location description":
      "We'll be meeting in Commissioner's Park north of Dow's Lake, find us near the statue of The Man With Two Hats, there will be a large yellow sign that says ACX facing the statue.",
  ...
  },
  {
    ...
    Notes:
      "If people would like to give a short presentation or lead a breakout activity, we will have a room set aside specifically for that at the event. Please fill out this google form to let me know what you would like present: https://forms.gle/opTeAXa5esPuxdBP9",
  ...
  },
  {
    ...
    "Location description":
      "Boulder Coffee Company at 100 Alexander St, Rochester, NY 14620.  I'll be wearing a green shirt, and I'll make an ACX Meetup sign for the table.  I'm a slightly pudgy male in my 50s.",
  ...
  },
  {
    ...
    "Location description":
      "\"Elsewhere Bar and Grill\", at the entrance from the river walk; an 'ACX' sign will be on a table facing the river and I will be wearing a black cowboy hat",
  ...
  },
  {
    ...
    "Location description":
      "Bird Park - I will be wearing a red shirt and there will be a sign that says Astral Codex Ten",
  ...
  },
  {
    ...
    "Location description":
      "We'll meet at Garfield Park, either at the picnic tables or on a blanket in a sunny spot somewhere. I'll be wearing a gray t-shirt.",
  ...
  },
  {
    ...
    "Location description":
      "Volunteer Park, by the amphitheater. I'll have a folding table set up, and probably a sign with ACX MEETUP on it.",
  ...
  },
  {
    ...
    "Location description":
      "Washington Park (840 W Washington Ave, Sunnyvale, CA 94086) We'll be in the northeast end of the park, under the trees in a large grassy area. There will be a folding table with an ACX Meetup sign taped to it.",
  ...
  },
  {
    ...
    "Location description":
      'Strange Brew Coffeehouse (1101 University Blvd, Tuscaloosa, AL 35401). We\'ll have a sign that says "ACX."',
  ...
  },
  {
    ...
    "Location description":
      "East Van Brewing, at Commercial &amp; Venables. We'll be on the top floor, and have a sign.",
  ...
  },
  {
    ...
    "Location description":
      "1275 1st Street, West Lafayette, IN 47906. We'll be in the south of the Earhart Hall lobby (not the dining court) near the piano, and I will be wearing a green shirt and carrying a sign with ACX MEETUP on it.",
  ...
  },
  {
    ...
    "Location description":
      "Grandview Public Market. 1401 Clare Ave, West Palm Beach, FL 33401. We'll be at the northeast outside area, sitting at a table with an ACX MEETUP sign on it. Parking is free at an adjacent lot, and there may also be a free valet service.",
    "Plus.Code Coordinates": "https://plus.codes/76RXMWXP+GH",
    Date: "05/27/2023",
    Time: "11:00:00 AM",
    "Event Link":
      "https://www.eventbrite.com/e/acx-meetups-everywhere-rationality-in-west-palm-beach-tickets-608249630017",
    Notes:
      "See our Eventbrite for more details, including meetup opportunities in Boca Raton, Delray Beach, and Boynton Beach.",
