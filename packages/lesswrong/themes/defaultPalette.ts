...
export const defaultComponentPalette = (shades: ThemeShadePalette): ThemeComponentPalette => ({
  text: {
    primary: shades.greyAlpha(0.87),
    secondary: shades.greyAlpha(0.54),
    normal: shades.greyAlpha(0.87),
    maxIntensity: shades.greyAlpha(1.0),
    slightlyIntense: shades.greyAlpha(0.92),
    slightlyIntense2: shades.greyAlpha(0.9),
    slightlyDim: shades.greyAlpha(0.8),
    slightlyDim2: shades.greyAlpha(0.7),
    dim: shades.greyAlpha(0.5),
    dim2: shades.grey[800],
    dim3: shades.grey[600],
    dim4: shades.grey[500],
    dim700: shades.grey[700],
    dim40: shades.greyAlpha(0.4),
    dim45: shades.greyAlpha(0.45),
    dim55: shades.greyAlpha(0.55),
    dim60: shades.greyAlpha(0.6),
    grey: shades.grey[650],
    spoilerBlockNotice: "#fff",
    notificationCount: shades.greyAlpha(0.6),
    notificationLabel: shades.greyAlpha(0.66),
    eventType: "#c0a688",
    tooltipText: "#fff",
  ...
  link: {
    unmarked: shades.greyAlpha(0.87),
    dim: shades.greyAlpha(0.5),
    dim2: shades.grey[600],
    dim3: shades.greyAlpha(0.4),
  ...
  linkHover: {
    dim: shades.greyAlpha(0.3),
  },
  icon: {
    normal: shades.greyAlpha(0.87),
    maxIntensity: shades.greyAlpha(1.0),
    slightlyDim: shades.greyAlpha(0.8),
    slightlyDim2: shades.greyAlpha(0.75),
    slightlyDim3: shades.greyAlpha(0.7),
    slightlyDim4: shades.greyAlpha(0.6),
    dim: shades.greyAlpha(0.5),
    dim2: shades.greyAlpha(0.4),
    dim3: shades.grey[400],
    dim4: shades.grey[500],
    dim5: shades.greyAlpha(0.3),
    dim6: shades.greyAlpha(0.2),
    dim55: shades.greyAlpha(0.55),
    dim600: shades.grey[600],
    dim700: shades.grey[700],
    tooltipUserMetric: "rgba(255,255,255,.8)",
    loadingDots: shades.greyAlpha(0.55),
    loadingDotsAlternate: shades.grey[0],
    horizRuleDots: shades.greyAlpha(0.26),
    ...
    commentsBubble: {
      commentCount: "#fff",
      noUnread: shades.greyAlpha(0.22),
      newPromoted: "rgb(160, 225, 165)",
    },
  },
  border: {
    normal: shades.greyBorder("1px", 0.2),
    itemSeparatorBottom: shades.greyBorder("2px", 0.05),
    slightlyFaint: shades.greyBorder("1px", 0.15),
    slightlyIntense: shades.greyBorder("1px", 0.25),
    slightlyIntense2: shades.greyBorder("1px", 0.3),
    slightlyIntense3: shades.greyBorder("1px", 0.4),
    intense: shades.greyBorder("2px", 0.5),
    faint: shades.greyBorder("1px", 0.1),
    extraFaint: shades.greyBorder("1px", 0.08),
  ...
  background: {
    ...
    diffInserted: "#d4ead4",
    diffDeleted: "#f0d3d3",
    usersListItem: shades.greyAlpha(0.05),
    primaryDim: "#e2f1f4",
  ...
  panelBackground: {
    ...
    hoverHighlightGrey: shades.greyAlpha(0.1),
    postsItemHover: shades.grey[50],
    formErrors: shades.greyAlpha(0.25),
    darken02: shades.greyAlpha(0.02),
    darken03: shades.greyAlpha(0.03),
    darken04: shades.greyAlpha(0.04),
    darken05: shades.greyAlpha(0.05),
    darken08: shades.greyAlpha(0.08),
    darken10: shades.greyAlpha(0.1),
    darken15: shades.greyAlpha(0.15),
    darken20: shades.greyAlpha(0.2),
    darken25: shades.greyAlpha(0.25),
    darken40: shades.greyAlpha(0.4),

    adminHomeRecentLogins: "rgba(50,100,50,.1)",
    adminHomeAllUsers: "rgba(100,50,50,.1)",
    deletedComment: "#ffefef",
    newCommentFormModerationGuidelines: shades.greyAlpha(0.07),
    ...
    spoilerBlock: "#000",
    revealedSpoilerBlock: shades.greyAlpha(0.12),
    ...
    tenPercent: shades.greyAlpha(0.1),
    ...
    sequenceImageGradient:
      "linear-gradient(to top, rgba(0, 0, 0, 0.5) 0%, rgba(0, 0, 0, 0.2) 42%, rgba(255, 255, 255, 0) 100%)",
    sequencesBanner: shades.greyAlpha(0.5),
  ...
  boxShadow: {
    default: `0 1px 5px ${shades.boxShadowColor(0.025)}`,
    moreFocused: `0 1px 3px ${shades.boxShadowColor(0.1)}`,
    faint: `0 1px 5px ${shades.boxShadowColor(0.1)}`,

    notificationsDrawer: `${shades.boxShadowColor(0.16)} 0px 3px 10px, ${shades.boxShadowColor(0.23)} 0px 3px 10px`,
    appBar: `0 1px 1px ${shades.boxShadowColor(0.05)}, 0 1px 1px ${shades.boxShadowColor(0.05)}`,
    sequencesGridItemHover: `0 1px 3px ${shades.boxShadowColor(0.1)}`,
    eventCard: `0 1px 3px ${shades.boxShadowColor(0.1)}`,
    mozillaHubPreview: `0px 0px 10px ${shades.boxShadowColor(0.1)}`,
    featuredResourcesCard: `0 4px 4px ${shades.boxShadowColor(0.07)}`,
    spreadsheetPage1: `2px 0 2px -1px ${shades.boxShadowColor(0.15)}`,
    spreadsheetPage2: `0 0 3px ${shades.boxShadowColor(0.3)}`,
    collectionsCardHover: `0 0 3px ${shades.boxShadowColor(0.1)}`,
    comment: `0 0 10px ${shades.boxShadowColor(0.2)}`,
    sunshineSidebarHoverInfo: `-3px 0 5px 0px ${shades.boxShadowColor(0.1)}`,
    sunshineSendMessage: `0 0 10px ${shades.boxShadowColor(0.5)}`,
    lwCard: `0 0 10px ${shades.boxShadowColor(0.2)}`,
    eaCard: `0 4px 8px ${shades.boxShadowColor(0.12)}`,
    searchResults: `0 0 20px ${shades.boxShadowColor(0.2)}`,
    recentDiscussionMeetupsPoke: `5px 5px 5px ${shades.boxShadowColor(0.2)}`,
    graphTooltip: `0 0 10px ${shades.boxShadowColor(0.75)}`,
  },
  buttons: {
    ...
    imageUpload: {
      background: shades.greyAlpha(0.5),
      hoverBackground: shades.greyAlpha(0.35),
    },
    imageUpload2: {
  ...
  tag: {
    text: shades.greyAlpha(0.9),
    background: shades.grey[200],
    border: `solid 1px ${shades.grey[200]}`,
    coreTagText: shades.grey[600],
    coreTagBackground: "transparent",
    coreTagBorder: shades.greyBorder("1px", 0.15),
    hollowTagBackground: shades.grey[0],
    hollowTagBorder: shades.greyBorder("1px", 0.15),
    boxShadow: `1px 2px 5px ${shades.boxShadowColor(0.2)}`,
  ...
  commentParentScrollerHover: shades.greyAlpha(0.075),
