...
export const namesAttachedReactions: NamesAttachedReactionType[] = [
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <p>
          <em>(In math, the triangle 'delta' symbol means 'change')</em>
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    description:
      "This conversation is suffering from an acute lack of understanding. Your interpretation of the other person's position is not right. Try coming at this conversation from a different angle.",
    // deprecated:true
  },
  {
    name: "nonSequitur",
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <p>
          <em>Note: you can inline react by selecting text</em>
        </p>
      </div>
    ),
    filter: { scale: 0.9, translateY: 2 },
  },
  {
    name: "laugh",
    label: "Haha!",
    ...
    description: "",
    filter: { opacity: 0.9, scale: 1.4, translateY: 2 },
  },
  {
    name: "disappointed",
    label: "Disappointed",
    ...
    filter: { opacity: 0.9, translateY: 2 },
    description: "",
  },
  {
    name: "sad",
  ...
  },
  {
    ...
    filter: { opacity: 0.9, translateY: -2.5, translateX: 0, scale: 1 },
  },
  {
    name: "smile",
    label: "Smile",
    ...
    filter: { opacity: 0.5, translateY: 2, scale: 1.4 },
  ...
  },
  {
    ...
    filter: { opacity: 0.7, translateY: 1, scale: 1.2 },
  },
  {
    name: "thumbs-up",
    label: "Thumbs Up",
    ...
    filter: { opacity: 0.5, translateY: 2 },
  },
  {
    name: "thumbs-down",
    label: "Thumbs Down",
    ...
    filter: { opacity: 0.5, translateY: 3 },
  },
  {
    name: "1percent",
    ...
    filter: { scale: 1.4, opacity: 0.5, translateY: 0.75, translateX: 0.5 },
  },
  {
    name: "10percent",
    label: "10% likely",
  ...
  },
  {
    ...
    filter: { scale: 1.4, opacity: 0.5, translateY: 1.25, translateX: 0.5 },
  },
  {
    name: "40percent",
    label: "~40% likely",
  ...
  },
  {
    ...
    filter: { scale: 1.25, opacity: 0.5, translateY: 0.75, translateX: 1 },
  },
  {
    name: "why",
    label: "Why? / Citation?",
