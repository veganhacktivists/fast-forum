...
importComponent("EAForumWrapped2022Page", () => require("../components/ea-forum/wrapped/EAForumWrapped2022Page"));
importComponent("EAForumWrapped2023Page", () => require("../components/ea-forum/wrapped/EAForumWrapped2023Page"));
...
importComponent("EAVotingPortalSelectCandidatesPage", () =>
  require("../components/ea-forum/voting-portal/EAVotingPortalSelectCandidatesPage"),
);
importComponent("EAVotingPortalComparePage", () =>
  require("../components/ea-forum/voting-portal/EAVotingPortalComparePage"),
);
importComponent("EAVotingPortalAllocateVotesPage", () =>
  require("../components/ea-forum/voting-portal/EAVotingPortalAllocateVotesPage"),
);
importComponent("EAVotingPortalSubmitPage", () =>
  require("../components/ea-forum/voting-portal/EAVotingPortalSubmitPage"),
);
...
importComponent("AdminElectionCandidates", () =>
  require("../components/ea-forum/giving-portal/AdminElectionCandidates"),
);
...
importComponent("DeleteElectionCandidateDialog", () =>
  require("../components/ea-forum/giving-portal/DeleteElectionCandidateDialog"),
);
...
importComponent(["EAGApplicationImportFormWrapper", "EAGApplicationImportForm"], () =>
  require("../components/ea-forum/users/EAGApplicationImportForm"),
);
...
importComponent("EAUsersProfileTabbedSection", () =>
  require("../components/ea-forum/users/modules/EAUsersProfileTabbedSection"),
);
...
importComponent(["PostSharingSettings", "PostSharingSettingsDialog"], () =>
  require("../components/editor/PostSharingSettings"),
);
...
importComponent("SuggestCuratedDropdownItem", () =>
  require("../components/dropdowns/posts/SuggestCuratedDropdownItem"),
);
...
importComponent("MoveToFrontpageDropdownItem", () =>
  require("../components/dropdowns/posts/MoveToFrontpageDropdownItem"),
);
importComponent("SuggestAlignmentPostDropdownItem", () =>
  require("../components/dropdowns/posts/SuggestAlignmentPostDropdownItem"),
);
importComponent("MoveToAlignmentPostDropdownItem", () =>
  require("../components/dropdowns/posts/MoveToAlignmentPostDropdownItem"),
);
importComponent("ShortformDropdownItem", () => require("../components/dropdowns/posts/ShortformDropdownItem"));
importComponent("ApproveNewUserDropdownItem", () =>
  require("../components/dropdowns/posts/ApproveNewUserDropdownItem"),
);
...
importComponent("DuplicateEventDropdownItem", () =>
  require("../components/dropdowns/posts/DuplicateEventDropdownItem"),
);
importComponent("HideFrontpagePostDropdownItem", () =>
  require("../components/dropdowns/posts/HideFrontpagePostDropdownItem"),
);
...
importComponent("EditPostDropdownItem", () => require("../components/dropdowns/posts/EditPostDropdownItem"));
importComponent("ExcludeFromRecommendationsDropdownItem", () =>
  require("../components/dropdowns/posts/ExcludeFromRecommendationsDropdownItem"),
);
...
importComponent("ReportCommentDropdownItem", () =>
  require("../components/dropdowns/comments/ReportCommentDropdownItem"),
);
importComponent("MoveToAlignmentCommentDropdownItem", () =>
  require("../components/dropdowns/comments/MoveToAlignmentCommentDropdownItem"),
);
importComponent("SuggestAlignmentCommentDropdownItem", () =>
  require("../components/dropdowns/comments/SuggestAlignmentCommentDropdownItem"),
);
importComponent("MoveToAnswersDropdownItem", () =>
  require("../components/dropdowns/comments/MoveToAnswersDropdownItem"),
);
importComponent("ShortformFrontpageDropdownItem", () =>
  require("../components/dropdowns/comments/ShortformFrontpageDropdownItem"),
);
importComponent("DeleteCommentDropdownItem", () =>
  require("../components/dropdowns/comments/DeleteCommentDropdownItem"),
);
importComponent("DeleteCommentDialog", () => require("../components/dropdowns/comments/DeleteCommentDialog"));
importComponent("RetractCommentDropdownItem", () =>
  require("../components/dropdowns/comments/RetractCommentDropdownItem"),
);
...
importComponent("BanUserFromPostDropdownItem", () =>
  require("../components/dropdowns/comments/BanUserFromPostDropdownItem"),
);
importComponent("BanUserFromAllPostsDropdownItem", () =>
  require("../components/dropdowns/comments//BanUserFromAllPostsDropdownItem"),
);
importComponent("BanUserFromAllPersonalPostsDropdownItem", () =>
  require("../components/dropdowns/comments/BanUserFromAllPersonalPostsDropdownItem"),
);
importComponent("ToggleIsModeratorCommentDropdownItem", () =>
  require("../components/dropdowns/comments/ToggleIsModeratorCommentDropdownItem"),
);
...
importComponent("NotificationEmailPreviewPage", () =>
  require("../components/notifications/NotificationEmailPreviewPage"),
);
importComponent("EmailPreview", () => require("../components/notifications/EmailPreview"));
importComponent("CommentOnYourDraftNotificationHover", () =>
  require("../components/notifications/CommentOnYourDraftNotificationHover"),
);
...
importComponent("TabNavigationMenuFooter", () =>
  require("../components/common/TabNavigationMenu/TabNavigationMenuFooter"),
);
importComponent("TabNavigationMenuCompressed", () =>
  require("../components/common/TabNavigationMenu/TabNavigationMenuCompressed"),
);
importComponent("TabNavigationItem", () => require("../components/common/TabNavigationMenu/TabNavigationItem"));
importComponent("TabNavigationFooterItem", () =>
  require("../components/common/TabNavigationMenu/TabNavigationFooterItem"),
);
importComponent("TabNavigationCompressedItem", () =>
  require("../components/common/TabNavigationMenu/TabNavigationCompressedItem"),
);
...
importComponent("GivingPortalMobileMenuItem", () =>
  require("../components/common/TabNavigationMenu/GivingPortalMobileMenuItem"),
);
importComponent("FeaturedResourceBanner", () =>
  require("../components/common/TabNavigationMenu/FeaturedResourceBanner"),
);
...
importComponent(
  [
    ...
    "PostLinkPreviewSequencePost",
    "PostLinkPreviewSlug",
    "PostLinkPreviewLegacy",
    "CommentLinkPreviewLegacy",
  ...
  () => require("../components/linkPreview/PostLinkPreview"),
);
...
importComponent("EmailConfirmationRequiredCheckbox", () =>
  require("../components/users/EmailConfirmationRequiredCheckbox"),
);
...
importComponent("LWPostsPreviewTooltip", () =>
  require("../components/posts/PostsPreviewTooltip/LWPostsPreviewTooltip"),
);
importComponent("EAPostsPreviewTooltip", () =>
  require("../components/posts/PostsPreviewTooltip/EAPostsPreviewTooltip"),
);
...
importComponent(["PostVersionHistory", "PostVersionHistoryButton"], () =>
  require("../components/editor/PostVersionHistory"),
);
importComponent(["TagVersionHistory", "TagVersionHistoryButton"], () =>
  require("../components/editor/TagVersionHistory"),
);
...
// Reaction components
importComponent(["NamesAttachedReactionsVoteOnComment", "NamesAttachedReactionsCommentBottom"], () =>
  require("../components/votes/lwReactions/NamesAttachedReactionsVoteOnComment"),
);
...
importComponent("InlineReactSelectionWrapper", () =>
  require("../components/votes/lwReactions/InlineReactSelectionWrapper"),
);
importComponent("InlineReactHoverableHighlight", () =>
  require("../components/votes/lwReactions/InlineReactHoverableHighlight"),
);
...
importComponent("HoveredReactionContextProvider", () =>
  require("../components/votes/lwReactions/HoveredReactionContextProvider"),
);
...
importComponent(["CommunityMap", "PersonalMapLocationMarkers"], () =>
  require("../components/localGroups/CommunityMap"),
);
...
importComponent("SetPersonalMapLocationDialog", () =>
  require("../components/localGroups/SetPersonalMapLocationDialog"),
);
...
importComponent("RecentDiscussionThreadsList", () =>
  require("../components/recentDiscussion/RecentDiscussionThreadsList"),
);
importComponent("RecentDiscussionFeed", () => require("../components/recentDiscussion/RecentDiscussionFeed"));
importComponent("RecentDiscussionTagRevisionItem", () =>
  require("../components/recentDiscussion/RecentDiscussionTagRevisionItem"),
);
importComponent("RecentDiscussionSubforumThread", () =>
  require("../components/recentDiscussion/RecentDiscussionSubforumThread"),
);
importComponent("RecentDiscussionSubscribeReminder", () =>
  require("../components/recentDiscussion/RecentDiscussionSubscribeReminder"),
);
importComponent("RecentDiscussionMeetupsPoke", () =>
  require("../components/recentDiscussion/RecentDiscussionMeetupsPoke"),
);
...
importComponent("EARecentDiscussionQuickTake", () =>
  require("../components/recentDiscussion/EARecentDiscussionQuickTake"),
);
importComponent("EARecentDiscussionTagRevision", () =>
  require("../components/recentDiscussion/EARecentDiscussionTagRevision"),
);
importComponent("EARecentDiscussionTagCommented", () =>
  require("../components/recentDiscussion/EARecentDiscussionTagCommented"),
);
importComponent("EARecentDiscussionElectionVote", () =>
  require("../components/recentDiscussion/EARecentDiscussionElectionVote"),
);
...
importComponent("DialoguesSectionFrontpageSettings", () =>
  require("../components/dialogues/DialoguesSectionFrontpageSettings"),
);
...
importComponent("ModerationGuidelinesBox", () =>
  require("../components/comments/ModerationGuidelines/ModerationGuidelinesBox"),
);
importComponent("ModerationGuidelinesEditForm", () =>
  require("../components/comments/ModerationGuidelines/ModerationGuidelinesEditForm"),
);
...
importComponent("ExpandedUsersConversationSearchHit", () =>
  require("../components/search/ExpandedUsersConversationSearchHit"),
);
...
importComponent("RecentlyActiveUsers", () =>
  require("../components/sunshineDashboard/ModeratorUserInfo/RecentlyActiveUsers"),
);
...
importComponent("RejectedCommentsList", () =>
  require("../components/sunshineDashboard/moderationLog/RejectedCommentsList"),
);
...
importComponent("SunshineCommentsItemOverview", () =>
  require("../components/sunshineDashboard/SunshineCommentsItemOverview"),
);
...
importComponent("UserReviewMetadata", () =>
  require("../components/sunshineDashboard/ModeratorUserInfo/UserReviewMetadata"),
);
importComponent("UserReviewStatus", () =>
  require("../components/sunshineDashboard/ModeratorUserInfo/UserReviewStatus"),
);
importComponent("AltAccountInfo", () => require("../components/sunshineDashboard/ModeratorUserInfo/AltAccountInfo"));
importComponent("ContentSummaryRows", () =>
  require("../components/sunshineDashboard/ModeratorUserInfo/ContentSummaryRows"),
);
importComponent("NewUserDMSummary", () =>
  require("../components/sunshineDashboard/ModeratorUserInfo/NewUserDMSummary"),
);
importComponent("ModeratorActionItem", () =>
  require("../components/sunshineDashboard/ModeratorUserInfo/ModeratorActionItem"),
);
importComponent("UserAutoRateLimitsDisplay", () =>
  require("../components/sunshineDashboard/ModeratorUserInfo/UserAutoRateLimitsDisplay"),
);
...
importComponent("SunshineNewUserCommentsList", () =>
  require("../components/sunshineDashboard/SunshineNewUserCommentsList"),
);
...
importComponent("SunshineNewUsersProfileInfo", () =>
  require("../components/sunshineDashboard/SunshineNewUsersProfileInfo"),
);
...
importComponent("SunshineReportedContentList", () =>
  require("../components/sunshineDashboard/SunshineReportedContentList"),
);
...
importComponent("SunshineCuratedSuggestionsItem", () =>
  require("../components/sunshineDashboard/SunshineCuratedSuggestionsItem"),
);
importComponent("SunshineCuratedSuggestionsList", () =>
  require("../components/sunshineDashboard/SunshineCuratedSuggestionsList"),
);
...
importComponent("SunshineSendMessageWithDefaults", () =>
  require("../components/sunshineDashboard/SunshineSendMessageWithDefaults"),
);
...
importComponent("NewCommentModerationWarning", () =>
  require("../components/sunshineDashboard/NewCommentModerationWarning"),
);
...
importComponent("SequencesHighlightsCollection", () =>
  require("../components/sequences/SequencesHighlightsCollection"),
);
...
importComponent("FormComponentPostEditorTagging", () =>
  require("../components/form-components/FormComponentPostEditorTagging"),
);
...
importComponent(["FormUsersListEditor", "UsersListEditor"], () =>
  require("../components/form-components/UsersListEditor"),
);
...
importComponent(["LocationPicker", "LocationFormComponent"], () =>
  require("../components/form-components/LocationFormComponent"),
);
...
importComponent(["MultiSelect", "FormComponentMultiSelect"], () =>
  require("../components/form-components/FormComponentMultiSelect"),
);
importComponent("FormComponentDate", () => require("../components/form-components/FormComponentDate"));
importComponent(["DatePicker", "FormComponentDateTime"], () =>
  require("../components/form-components/FormComponentDateTime"),
);
...
importComponent(["CommentOnSelectionPageWrapper", "SelectedTextToolbar", "CommentOnSelectionContentWrapper"], () =>
  require("../components/comments/CommentOnSelection"),
);
...
importComponent("AlignmentPendingApprovalMessage", () =>
  require("../components/alignment-forum/AlignmentPendingApprovalMessage"),
);
...
importComponent("ConfigurableRecommendationsList", () =>
  require("../components/recommendations/ConfigurableRecommendationsList"),
);
importComponent("ContinueReadingList", () => require("../components/recommendations/ContinueReadingList"));
importComponent("RecommendationsAlgorithmPicker", () =>
  require("../components/recommendations/RecommendationsAlgorithmPicker"),
);
importComponent("RecommendationsList", () => require("../components/recommendations/RecommendationsList"));
importComponent("PostsPageRecommendationsList", () =>
  require("../components/recommendations/PostsPageRecommendationsList"),
);
importComponent("PostsPageRecommendationItem", () =>
  require("../components/recommendations/PostsPageRecommendationItem"),
);
...
importComponent("RecommendationsPageCuratedList", () =>
  require("../components/recommendations/RecommendationsPageCuratedList"),
);
...
importComponent("SpotlightStartOrContinueReading", () =>
  require("../components/spotlights/SpotlightStartOrContinueReading"),
);
