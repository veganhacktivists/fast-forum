...
export const donationElectionLink =
  "/posts/hAzhyikPnLnMXweXG/participate-in-the-donation-election-and-the-first-weekly";
export const donationElectionFundraiserLink =
  "https://www.givingwhatwecan.org/fundraisers/ea-forum-donation-election-fund-2023";
...
export const electionCandidatesPostLink =
  "/posts/bBm64htDSKn3ZKiQ5/meet-the-candidates-in-the-forum-s-donation-election-2023";
...
export const userCanVoteInDonationElection = (user: UsersCurrent | DbUser | null) =>
  !!user && new Date(user.createdAt).getTime() < votingAccountCreationCutoff.getTime();

export const assertUserCanVoteInDonationElection = (user: UsersCurrent | DbUser | null) => {
...
export const otherDonationOpportunities = [
  {
    ...
    description:
      "CEA helps to build and nurture the EA community; running EA conferences, the EA Forum, supporting groups, writing newsletters and content, and more.",
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701460414/Screen_Shot_2023-12-01_at_2.53.11_PM",
  ...
  },
  {
    ...
    description:
      "CEELAR is a free/subsidized living space for people seeking to do the most good they can with their time/resources.",
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701453334/ZKCwwjyBMw2iA8ox6u1TJZCYqEphFaUlMEkXbKTXYZ9iE52L7KvDPVfy4WWQPD8SHRk9mK96bGB6-rssjrUKbjY_w16383",
  ...
  },
  {
    ...
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701453716/Screen_Shot_2023-12-01_at_1.01.42_PM",
  ...
  },
  {
    ...
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701457394/lic-2023-logo-black-stacked-transparent-1",
  ...
  },
  {
    ...
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701457636/Screen_Shot_2023-12-01_at_2.07.02_PM",
  ...
  },
  {
    ...
    name: "PIBBSS",
    description:
      "PIBBSS is a program that facilitates research into the analogy between natural and artificial systems, in order to progress work on AI safety.",
  ...
  },
  {
    ...
    description:
      "RCG investigates science policy opportunities to improve the management of GCRs in Spanish speaking countries.",
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701458346/Screen_Shot_2023-12-01_at_2.18.49_PM",
  ...
  },
  {
    ...
    description:
      "Hi-Med is a program for promoting impact-driven careers and giving amongst medical students and professionals.",
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701459039/Screen_Shot_2023-12-01_at_2.30.26_PM",
  ...
  },
  {
    ...
    logoSrc:
      "https://res.cloudinary.com/cea/image/upload/q_auto,f_auto/v1701459133/Screen_Shot_2023-12-01_at_2.31.57_PM",
  ...
  },
  {
    ...
    name: "Vida Plena",
    description:
      "Vida Plena is a program that trains local communities to provide mental health care for depression in Latin America.",
