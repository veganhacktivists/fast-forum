...
export const Link = ({ eventProps, ...props }: LinkProps) => {
  const { captureEvent } = useTracking({
    ...
    eventProps: { to: props.to, ...(eventProps ?? {}) },
  });
...
export const QueryLink: FC<
  Omit<reactRouterDom.LinkProps, "to"> & {
