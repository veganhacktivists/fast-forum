...
const taggingDashboardSubtitle = {
  subtitleLink: "/tags/dashboard",
  subtitle: `${taggingNameIsSet.get() ? taggingNamePluralCapitalSetting.get() : "Wiki-Tag"} Dashboard`,
};
...
addRoute(
  // The page itself
  {
    ...
    description: isEAForum
      ? `Browse the core ${taggingNamePluralSetting.get()} discussed on the FAST Forum and an organised wiki of key ${taggingNameSetting.get()} pages`
      : undefined,
  },
...
onStartup(() => {
  ...
  addRoute(
    ...
    {
      name: "post.legacy",
      path: `/:section?/:subreddit(all|discussion|lesswrong)?/${legacyRouteAcronym}/:id/:slug?`,
    ...
    {
      name: "comment.legacy",
      path: `/:section?/:subreddit(all|discussion|lesswrong)?/${legacyRouteAcronym}/:id/:slug/:commentId`,
  ...
  EAForum: [
    {
      ...
      description:
        "Animal Advocacy Forum is a space for advocates and organizations to engage, collaborate, and strategize on a wide range of topics surrounding factory farming, encouraging long-form and strategic discussions.",
    ...
    },
    {
      ...
      title: "Groups & people",
      description:
        "Discover local and online EA groups, or browse the members of the forum to find people to connect with.",
      ...communitySubtitle,
    },
    {
