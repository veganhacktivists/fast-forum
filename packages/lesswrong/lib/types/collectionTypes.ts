...
declare global {
  ...
  type ViewQueryAndOptions<N extends CollectionNameString, T extends DbObject = ObjectsByCollectionName[N]> = {
  ...
  type MongoModifier<T extends DbObject> = {
    $inc?: any;
    $min?: any;
    $max?: any;
    $mul?: any;
  ...
  type CreateMutator = <N extends CollectionNameString>(
    args: CreateMutatorParams<N>,
  ) => Promise<{ data: ObjectsByCollectionName[N] }>;
  ...
  type UpdateMutatorParams<N extends CollectionNameString> =
    | UpdateMutatorParamsWithDocId<N>
    | UpdateMutatorParamsWithSelector<N>;

  type UpdateMutator = <N extends CollectionNameString>(
    args: UpdateMutatorParams<N>,
  ) => Promise<{ data: ObjectsByCollectionName[N] }>;
  ...
  type DeleteMutator = <N extends CollectionNameString>(
    args: DeleteMutatorParams<N>,
  ) => Promise<{ data: ObjectsByCollectionName[N] }>;
}
