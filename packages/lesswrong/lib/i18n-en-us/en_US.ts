...
addStrings("en", {
  "Incorrect password":
    "Wrong password (If you've just come from LW 1.0 you'll need to reset your password, using the email address associated with your LW 1.0 account.)",
  ...
  "Email already exists.":
    "Email already exists. If you have an LW 1.0 account, please reset your password with the link above",
});
...
addStrings("en", {
  ...
  "accounts.error_error_too_many_requests_please_slow_down_you_must_wait_8_seconds_before_trying_again":
    "Error, too many requests. Please slow down. You must wait 8 seconds before trying again.",
...
addStrings("en", {
  "alignment.comments.please_log_in":
    "Please log in to comment. (Commenting is limited to AI Alignment Forum members. Non-members should comment on LessWrong.com)",
