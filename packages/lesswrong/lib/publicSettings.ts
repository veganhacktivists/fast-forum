...
export class DatabasePublicSetting<SettingValueType> {
  ...
  get(): SettingValueType {
    ...
    if (!getPublicSettingsLoaded())
      throw Error(`Tried to access public setting ${this.settingName} before it was initialized`);
...
export const showReviewOnFrontPageIfActive = new DatabasePublicSetting<boolean>(
  "annualReview.showReviewOnFrontPageIfActive",
  true,
);
...
export const annualReviewVotingResultsPostPath = new DatabasePublicSetting<string>(
  "annualReview.votingResultsPostPath",
  "",
);
...
export const performanceMetricLoggingEnabled = new DatabasePublicSetting<boolean>(
  "performanceMetricLoggingEnabled",
  false,
);
export const performanceMetricLoggingBatchSize = new DatabasePublicSetting<number>(
  "performanceMetricLoggingBatchSize",
  100,
);
// Null means requests are disabled
export const requestFeedbackKarmaLevelSetting = new DatabasePublicSetting<number | null>(
  "post.requestFeedbackKarmaLevel",
  100,
);
