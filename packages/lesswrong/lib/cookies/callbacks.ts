...
export const cookiePreferencesChangedCallbacks = new CallbackChainHook<CookiePreferencesChangedCallbackProps, []>(
 ...
 */
cookiePreferencesChangedCallbacks.add(
  ({ cookiePreferences, explicitlyChanged }: CookiePreferencesChangedCallbackProps) => {
