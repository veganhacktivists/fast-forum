...
const reviewPostIdSetting = {
  get: () => (isEAForum ? annualReviewAnnouncementPostPathSetting.get()?.match(/^\/posts\/([a-zA-Z\d]+)/)?.[1] : null),
};

export const tagSettingIcons = new Map<
  DatabasePublicSetting<string | null>,
