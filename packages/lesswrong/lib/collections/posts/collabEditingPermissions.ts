...
export function strongerAccessLevel(
  a: CollaborativeEditingAccessLevel | null,
  b: CollaborativeEditingAccessLevel | null,
...
export async function getCollaborativeEditorAccess({
  formType,
  post,
  user,
  context,
