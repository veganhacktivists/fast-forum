...
export const sequenceGetAllPosts = async (
...
const getSurroundingSequencePostIdTuples = async function (sequenceId: string, context: ResolverContext) {
  ...
  const postIdsBySequence = await Promise.all(
    surroundingSequenceIds.map((seqId) =>
      sequenceGetAllPostIDs(seqId, context).then((postIds) => postIds.map((postId) => ({ sequenceId: seqId, postId }))),
    ),
  );
 ...
 */
export const getNextPostIdFromNextSequence = async function (
  sequenceId: string,
  postId: string,
  context: ResolverContext,
): Promise<SequencePostId | undefined> {
...
// returns null.
export const sequenceGetNextPostID = async function (
  sequenceId: string,
  postId: string,
  context: ResolverContext,
): Promise<string | null> {
 ...
 */
export const getPrevPostIdFromPrevSequence = async function (
  sequenceId: string,
  postId: string,
  context: ResolverContext,
): Promise<SequencePostId | undefined> {
...
export const sequenceGetPrevPostID = async function (
  sequenceId: string,
  postId: string,
  context: ResolverContext,
): Promise<string | null> {
...
export const sequenceContainsPost = async function (
  sequenceId: string,
  postId: string,
  context: ResolverContext,
): Promise<boolean> {
