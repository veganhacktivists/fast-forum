...
declare global {
  type CommentModeratorActionsViewTerms = NoViewTerms | ActiveCommentModeratorActionsViewTerms;
}

CommentModeratorActions.addView(
  "activeCommentModeratorActions",
  function (terms: ActiveCommentModeratorActionsViewTerms) {
    return {
      selector: {
