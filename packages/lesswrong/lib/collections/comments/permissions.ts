...
const sunshineRegimentActions = ["comments.softRemove.all", "comments.replyOnBlocked.all", "comments.edit.all"];
sunshineRegimentGroup.can(sunshineRegimentActions);

const votingActions = ["comments.smallDownvote", "comments.bigDownvote", "comments.smallUpvote", "comments.bigUpvote"];
