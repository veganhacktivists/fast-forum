...
export async function commentGetPageUrlFromDB(
  comment: DbComment,
...
export function commentGetPageUrlFromIds({
  postId,
  postSlug,
  tagSlug,
  tagCommentType,
...
export const commentDefaultToAlignment = (
...
export const commentGetDefaultView = (
...
export const commentAllowTitle = (comment: {
  tagCommentType: TagCommentType;
  parentCommentId?: string | null;
}): boolean => comment?.tagCommentType === "SUBFORUM" && !comment?.parentCommentId;
