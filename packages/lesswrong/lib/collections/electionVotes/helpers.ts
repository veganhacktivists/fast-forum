...
export const ELECTION_EFFECT_QUESTION =
 ...
 * the database
 */
export const formStateToSubmissionComments = ({
  electionEffect,
  note,
}: {
  electionEffect: string;
 ...
 */
export const submissionCommentsToFormState = (
  submissionComments?: SubmissionComments,
): { electionEffect: string; note: string } => {
  return {
