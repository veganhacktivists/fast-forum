...
export async function userHasActiveModeratorActionOfType(
  userId: string,
  moderatorActionType: keyof typeof MODERATOR_ACTION_TYPES,
): Promise<boolean> {
...
export function isLowAverageKarmaContent(
  content: ModeratableContent[],
  contentType: "post" | "comment",
): KarmaContentJudgment {
...
const reviewReasonsSetting = new DatabasePublicSetting<Array<ReasonForInitialReview>>(
